...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('experts_collaboration', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['data.Entry'])),
        ))
        db.send_create_signal('experts', ['Collaboration'])

        # Adding M2M table for field labs on 'Collaboration'
        db.create_table('experts_collaboration_labs', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('collaboration', models.ForeignKey(orm['experts.collaboration'], null=False)),
            ('link', models.ForeignKey(orm['links.link'], null=False))
        ))
        db.create_unique('experts_collaboration_labs', ['collaboration_id', 'link_id'])

        # Adding M2M table for field members on 'Collaboration'
        db.create_table('experts_collaboration_members', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('collaboration', models.ForeignKey(orm['experts.collaboration'], null=False)),
            ('profile', models.ForeignKey(orm['experts.profile'], null=False))
        ))
        db.create_unique('experts_collaboration_members', ['collaboration_id', 'profile_id'])


    def backwards(self, orm):
        # Deleting model 'Collaboration'
        db.delete_table('experts_collaboration')

        # Removing M2M table for field labs on 'Collaboration'
        db.delete_table('experts_collaboration_labs')

        # Removing M2M table for field members on 'Collaboration'
        db.delete_table('experts_collaboration_members')
