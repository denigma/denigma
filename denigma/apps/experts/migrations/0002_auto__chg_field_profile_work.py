...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('experts_profile', 'work', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Profile.work'
        db.alter_column('experts_profile', 'work', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))
