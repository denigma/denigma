...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('experts_profile', 'affliation', 'affiliation')

        # Adding field 'Profile.middle_name'
        db.add_column('experts_profile', 'middle_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'Profile.city'
        db.add_column('experts_profile', 'city',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)

        # Adding field 'Profile.phone'
        db.add_column('experts_profile', 'phone',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


        # Adding M2M table for field publications on 'Profile'
        db.create_table('experts_profile_publications', (
        ...
        db.create_unique('experts_profile_publications', ['profile_id', 'reference_id'])


    def backwards(self, orm):
        # Adding field 'Profile.affliation'
        db.rename_column('experts_profile', 'affiliation', 'affliation')

        # Deleting field 'Profile.middle_name'
        db.delete_column('experts_profile', 'middle_name')

        # Deleting field 'Profile.city'
        db.delete_column('experts_profile', 'city')

        # Deleting field 'Profile.phone'
        db.delete_column('experts_profile', 'phone')

        # Removing M2M table for field publications on 'Profile'
        db.delete_table('experts_profile_publications')
