...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.user_name'
        db.alter_column('experts_profile', 'user_name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=40))

    def backwards(self, orm):

        # Changing field 'Profile.user_name'
        db.alter_column('experts_profile', 'user_name', self.gf('django.db.models.fields.CharField')(max_length=30, unique=True))
