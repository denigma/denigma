...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('experts_profile', 'skype',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field images on 'Profile'
        db.create_table('experts_profile_images', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('profile', models.ForeignKey(orm['experts.profile'], null=False)),
            ('image', models.ForeignKey(orm['media.image'], null=False))
        ))
        db.create_unique('experts_profile_images', ['profile_id', 'image_id'])


    def backwards(self, orm):
        # Deleting field 'Profile.skype'
        db.delete_column('experts_profile', 'skype')

        # Removing M2M table for field images on 'Profile'
        db.delete_table('experts_profile_images')
    ...
    models = {
        ...
        'experts.profile': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'images': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['media.Image']", 'null': 'True', 'blank': 'True'}),
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            ...
            'user_name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '40', 'blank': 'True'}),
