...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('experts_profile', 'phone', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

    def backwards(self, orm):

        # Changing field 'Profile.phone'
        db.alter_column('experts_profile', 'phone', self.gf('django.db.models.fields.IntegerField')(null=True))
