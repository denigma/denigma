...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Profile.instituition_name'
        db.delete_column('users_profile', 'instituition_name')

        # Deleting field 'Profile.primary_email'
        db.delete_column('users_profile', 'primary_email')

        # Adding field 'Profile.email'
        db.add_column('users_profile', 'email', self.gf('django.db.models.fields.EmailField')(default='', max_length=60, blank=True), keep_default=False)

        # Adding field 'Profile.affliation'
        db.add_column('users_profile', 'affliation', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Profile.work'
        db.add_column('users_profile', 'work', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True), keep_default=False)

        # Adding field 'Profile.website'
        db.add_column('users_profile', 'website', self.gf('django.db.models.fields.URLField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Profile.instituition_name'
        db.add_column('users_profile', 'instituition_name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Adding field 'Profile.primary_email'
        db.add_column('users_profile', 'primary_email', self.gf('django.db.models.fields.EmailField')(default='', max_length=60, blank=True), keep_default=False)

        # Deleting field 'Profile.email'
        db.delete_column('users_profile', 'email')

        # Deleting field 'Profile.affliation'
        db.delete_column('users_profile', 'affliation')

        # Deleting field 'Profile.work'
        db.delete_column('users_profile', 'work')
    ...
    models = {
        ...
        'users.profile': {
            ...
            'affliation': ('django.db.models.fields.CharField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
