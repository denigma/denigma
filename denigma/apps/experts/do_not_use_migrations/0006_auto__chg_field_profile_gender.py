...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('users_profile', 'gender', self.gf('django.db.models.fields.PositiveSmallIntegerField')(max_length=1, null=True))


    def backwards(self, orm):
        
        # Changing field 'Profile.gender'
        db.alter_column('users_profile', 'gender', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))
