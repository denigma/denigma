...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.work'
        db.alter_column('users_profile', 'work', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))


    def backwards(self, orm):
        
        # Changing field 'Profile.work'
        db.alter_column('users_profile', 'work', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))
