...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('users_workinghour', (
        ...
        db.create_table('users_profile_business_hours', (
            ...
            ('businesshour', models.ForeignKey(orm['users.businesshour'], null=False))
        ))
        db.create_unique('users_profile_business_hours', ['profile_id', 'businesshour_id'])
        ...
        db.create_table('users_openingtime', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('day', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('start', self.gf('django.db.models.fields.TimeField')()),
            ('end', self.gf('django.db.models.fields.TimeField')()),
        ))
        db.send_create_signal('users', ['OpeningTime'])


    def backwards(self, orm):
        
        # Deleting model 'WorkingHour'
        db.delete_table('users_workinghour')

        # Deleting model 'BusinessHour'
        db.delete_table('users_businesshour')
        ...
        db.delete_table('users_openingtime')
