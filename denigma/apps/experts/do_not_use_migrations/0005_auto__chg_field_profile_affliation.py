...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.affliation'
        db.alter_column('users_profile', 'affliation', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))


    def backwards(self, orm):
        
        # Changing field 'Profile.affliation'
        db.alter_column('users_profile', 'affliation', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
