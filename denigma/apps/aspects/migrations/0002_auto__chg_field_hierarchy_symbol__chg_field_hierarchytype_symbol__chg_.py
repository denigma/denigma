...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('aspects_hierarchy', 'symbol_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['media.Image'], null=True))

        # Changing field 'HierarchyType.symbol'
        db.alter_column('aspects_hierarchytype', 'symbol_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['media.Image'], null=True))

        # Changing field 'Language.symbol'
        db.alter_column('aspects_language', 'symbol_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['media.Image'], null=True))

    def backwards(self, orm):

        # Changing field 'Hierarchy.symbol'
        db.alter_column('aspects_hierarchy', 'symbol_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['media.Image']))

        # Changing field 'HierarchyType.symbol'
        db.alter_column('aspects_hierarchytype', 'symbol_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['media.Image']))

        # Changing field 'Language.symbol'
        db.alter_column('aspects_language', 'symbol_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['media.Image']))
