...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Grade.language'
        db.alter_column('aspects_grade', 'language_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['aspects.Language'], null=True))

    def backwards(self, orm):

        # Changing field 'Grade.language'
        db.alter_column('aspects_grade', 'language_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['aspects.Language']))
