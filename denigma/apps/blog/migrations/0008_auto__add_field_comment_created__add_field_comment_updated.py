...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('blog_comment', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2012, 10, 12, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Comment.updated'
        db.add_column('blog_comment', 'updated',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 10, 12, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Comment.created'
        db.delete_column('blog_comment', 'created')

        # Deleting field 'Comment.updated'
        db.delete_column('blog_comment', 'updated')
