...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Todo.importance' to 'Todo.priority'
        db.rename_column('todos_todo', 'importance', 'priority')

        # Adding field 'Todo.value'
        db.add_column('todos_todo', 'value',
    ...
    def backwards(self, orm):
        ...
        # Renaming field 'Todo.priority' to 'Todo.importance'
        db.rename_column('todos_todo', 'priority', 'importance')

        # Deleting field 'Todo.value'
        db.delete_column('todos_todo', 'value')
    ...
    models = {
        ...
        'todos.todo': {
            ...
            'priority': ('django.db.models.fields.CharField', [], {'default': "'C'", 'max_length': '1'}),
