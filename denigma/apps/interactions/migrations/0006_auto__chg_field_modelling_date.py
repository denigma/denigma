...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Modelling.date'
        db.alter_column('interactions_modelling', 'date', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))


    def backwards(self, orm):
        
        # Changing field 'Modelling.date'
        db.alter_column('interactions_modelling', 'date', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    models = {
        ...
        'interactions.modelling': {
            ...
            'date': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
