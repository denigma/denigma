...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Yeast_TF_ChIP_chip'
        db.create_table('interactions_yeast_tf_chip_chip', (
        ...
        db.send_create_signal('interactions', ['Yeast_TF_ChIP_chip'])


    def backwards(self, orm):
        
        # Deleting model 'Yeast_TF_ChIP_chip'
        db.delete_table('interactions_yeast_tf_chip_chip')
