...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Yeastract.tf_ensembl_id'
        db.add_column('interactions_yeastract', 'tf_ensembl_id', self.gf('django.db.models.fields.CharField')(default=0, max_length=9), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Yeastract.tf_ensembl_id'
        db.delete_column('interactions_yeastract', 'tf_ensembl_id')
