...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('interactions_yeastract', (
            ...
            ('target_gene', self.gf('django.db.models.fields.CharField')(max_length=9)),
            ...
            ('source_mapping', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('target_mapping', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
