...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Int'
        db.create_table('interactions_int', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('unique_id_a', self.gf('django.db.models.fields.IntegerField')()),
            ('unique_id_b', self.gf('django.db.models.fields.IntegerField')()),
            ('alias_a', self.gf('django.db.models.fields.TextField')()),
            ('alias_b', self.gf('django.db.models.fields.TextField')()),
            ('experimental_system_type', self.gf('django.db.models.fields.CharField')(max_length=48, blank=True)),
            ('interaction_type', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('experimental_system', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('modification', self.gf('django.db.models.fields.CharField')(max_length=61, blank=True)),
        ...
        db.send_create_signal('interactions', ['Int'])


    def backwards(self, orm):
        
        # Deleting model 'Int'
        db.delete_table('interactions_int')
    ...
    models = {
        ...
        'interactions.int': {
            'Meta': {'object_name': 'Int'},
            'alias_a': ('django.db.models.fields.TextField', [], {}),
            'alias_b': ('django.db.models.fields.TextField', [], {}),
            'experimental_system': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'experimental_system_type': ('django.db.models.fields.CharField', [], {'max_length': '48', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'interaction_type': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'modification': ('django.db.models.fields.CharField', [], {'max_length': '61', 'blank': 'True'}),
            ...
            'unique_id_a': ('django.db.models.fields.IntegerField', [], {}),
            'unique_id_b': ('django.db.models.fields.IntegerField', [], {})
        },
