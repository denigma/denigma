...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'miRecord'
        db.create_table('interactions_mirecord', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pubmed_id', self.gf('django.db.models.fields.IntegerField')()),
            ('target_gene_species_scientific', self.gf('django.db.models.fields.CharField')(max_length=34, blank=True)),
            ('target_gene_species_common', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('target_gene_name', self.gf('django.db.models.fields.CharField')(max_length=44, blank=True)),
            ('target_gene_refseq_acc', self.gf('django.db.models.fields.CharField')(max_length=14, blank=True)),
            ('target_site_number', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('mirna_species', self.gf('django.db.models.fields.CharField')(max_length=37, blank=True)),
            ('mirna_mature_id', self.gf('django.db.models.fields.CharField')(max_length=18, blank=True)),
            ('mirna_regulation', self.gf('django.db.models.fields.CharField')(max_length=66, blank=True)),
            ('reporter_target_gene_region', self.gf('django.db.models.fields.CharField')(max_length=26, blank=True)),
            ('reporter_link_element1', self.gf('django.db.models.fields.CharField')(max_length=24, blank=True)),
            ('test_method_inter', self.gf('django.db.models.fields.CharField')(max_length=34, blank=True)),
            ('target_gene_mrna_level', self.gf('django.db.models.fields.CharField')(max_length=9, blank=True)),
            ('original_description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('mutation_target_region', self.gf('django.db.models.fields.CharField')(max_length=3, blank=True)),
            ('post_mutation_method', self.gf('django.db.models.fields.CharField')(max_length=3, blank=True)),
            ('original_description_mutation_region', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('target_site_position', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('mirna_regulation_site', self.gf('django.db.models.fields.CharField')(max_length=63, blank=True)),
            ('reporter_target_site', self.gf('django.db.models.fields.CharField')(max_length=26, blank=True)),
            ('reporter_link_element2', self.gf('django.db.models.fields.CharField')(max_length=25, blank=True)),
            ('test_method_inter_site', self.gf('django.db.models.fields.CharField')(max_length=27, blank=True)),
            ('original_description_inter_site', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('mutation_target_site', self.gf('django.db.models.fields.CharField')(max_length=3, blank=True)),
            ('post_mutation_method_site', self.gf('django.db.models.fields.CharField')(max_length=27, blank=True)),
            ('original_description_mutation_site', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('additional_note', self.gf('django.db.models.fields.CharField')(max_length=141, blank=True)),
        ))
        db.send_create_signal('interactions', ['miRecord'])


    def backwards(self, orm):
        
        # Deleting model 'miRecord'
        db.delete_table('interactions_mirecord')
