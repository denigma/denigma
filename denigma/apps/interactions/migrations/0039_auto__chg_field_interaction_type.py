...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Interaction.type'
        db.alter_column('interactions_interaction', 'type', self.gf('django.db.models.fields.CharField')(max_length=259))

    def backwards(self, orm):

        # Changing field 'Interaction.type'
        db.alter_column('interactions_interaction', 'type', self.gf('django.db.models.fields.CharField')(max_length=255))
