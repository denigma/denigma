...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'tnet'
        db.create_table('interactions_tnet', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('tf', self.gf('django.db.models.fields.CharField')(max_length=7)),
            ('tg', self.gf('django.db.models.fields.CharField')(max_length=8)),
        ))
        db.send_create_signal('interactions', ['tnet'])


    def backwards(self, orm):
        
        # Deleting model 'tnet'
        db.delete_table('interactions_tnet')
