...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Interaction.modification'
        db.alter_column('interactions_interaction', 'modification', self.gf('django.db.models.fields.CharField')(max_length=78))

    def backwards(self, orm):

        # Changing field 'Interaction.modification'
        db.alter_column('interactions_interaction', 'modification', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        'interactions.interaction': {
            ...
            'modification': ('django.db.models.fields.CharField', [], {'max_length': '78', 'blank': 'True'}),
            ...
            'type': ('django.db.models.fields.CharField', [], {'max_length': '259', 'blank': 'True'})
        },
