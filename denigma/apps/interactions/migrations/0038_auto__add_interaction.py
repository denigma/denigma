...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('interactions_interaction', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('id_a', self.gf('django.db.models.fields.IntegerField')()),
            ('id_b', self.gf('django.db.models.fields.IntegerField')()),
            ('alias_a', self.gf('django.db.models.fields.TextField')()),
            ('alias_b', self.gf('django.db.models.fields.TextField')()),
            ('system', self.gf('django.db.models.fields.CharField')(max_length=38, blank=True)),
            ('type', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('method', self.gf('django.db.models.fields.CharField')(max_length=240, blank=True)),
            ...
            ('source', self.gf('django.db.models.fields.CharField')(max_length=73)),
            ('score', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('interactions', ['Interaction'])


    def backwards(self, orm):
        # Deleting model 'Interaction'
        db.delete_table('interactions_interaction')
    ...
    models = {
        ...
        'interactions.interaction': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'id_a': ('django.db.models.fields.IntegerField', [], {}),
            'id_b': ('django.db.models.fields.IntegerField', [], {}),
            'method': ('django.db.models.fields.CharField', [], {'max_length': '240', 'blank': 'True'}),
            ...
            'source': ('django.db.models.fields.CharField', [], {'max_length': '73'}),
            'system': ('django.db.models.fields.CharField', [], {'max_length': '38', 'blank': 'True'}),
