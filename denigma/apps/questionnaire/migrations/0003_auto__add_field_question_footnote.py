...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.footnote'
        db.add_column('questionnaire_question', 'footnote',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.footnote'
        db.delete_column('questionnaire_question', 'footnote')
