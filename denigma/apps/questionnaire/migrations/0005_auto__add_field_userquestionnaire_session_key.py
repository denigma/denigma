...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserQuestionnaire.session_key'
        db.add_column('questionnaire_userquestionnaire', 'session_key',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserQuestionnaire.session_key'
        db.delete_column('questionnaire_userquestionnaire', 'session_key')
