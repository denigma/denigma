...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('questionnaire_answer', 'answer', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Answer.answer'
        db.alter_column('questionnaire_answer', 'answer', self.gf('django.db.models.fields.CharField')(max_length=200))
