...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Thanks'
        db.create_table('questionnaire_thanks', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('text', self.gf('django.db.models.fields.TextField')()),
            ('questionnaire', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='thanks', null=True, to=orm['questionnaire.Questionnaire'])),
        ))
        db.send_create_signal('questionnaire', ['Thanks'])


    def backwards(self, orm):
        # Deleting model 'Thanks'
        db.delete_table('questionnaire_thanks')
