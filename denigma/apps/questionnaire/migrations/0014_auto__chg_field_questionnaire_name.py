...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Questionnaire.name'
        db.alter_column('questionnaire_questionnaire', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))

    def backwards(self, orm):

        # Changing field 'Questionnaire.name'
        db.alter_column('questionnaire_questionnaire', 'name', self.gf('django.db.models.fields.CharField')(max_length=60, unique=True))
    ...
    models = {
        ...
        'questionnaire.header': {
            ...
            'section': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'headers'", 'to': "orm['questionnaire.Section']"})
        },
