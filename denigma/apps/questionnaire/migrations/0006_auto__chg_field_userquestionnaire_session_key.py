...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserQuestionnaire.session_key'
        db.alter_column('questionnaire_userquestionnaire', 'session_key', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'UserQuestionnaire.session_key'
        db.alter_column('questionnaire_userquestionnaire', 'session_key', self.gf('django.db.models.fields.CharField')(max_length=40))
