...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('track_visitor', (
            ...
            ('start_time', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 12, 16, 0, 0))),
            ('expiry_age', self.gf('django.db.models.fields.IntegerField')(null=True)),
        ...
        db.send_create_signal('track', ['Visitor'])

        # Adding model 'Activity'
        db.create_table('track_activity', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('visitor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='activity', to=orm['track.Visitor'])),
            ('url', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('view_time', self.gf('django.db.models.fields.DateTimeField')()),
        ))
        db.send_create_signal('track', ['Activity'])

        # Adding model 'UntrackedUserAgent'
        db.create_table('track_untrackeduseragent', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('keyword', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('track', ['UntrackedUserAgent'])

        # Adding model 'BannedIP'
        db.create_table('track_bannedip', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ip_address', self.gf('django.db.models.fields.IPAddressField')(max_length=15)),
        ))
        db.send_create_signal('track', ['BannedIP'])


    def backwards(self, orm):
        # Deleting model 'Visitor'
        db.delete_table('track_visitor')

        # Deleting model 'Activity'
        db.delete_table('track_activity')

        # Deleting model 'UntrackedUserAgent'
        db.delete_table('track_untrackeduseragent')

        # Deleting model 'BannedIP'
        db.delete_table('track_bannedip')
    ...
    models = {
        ...
        'track.visitor': {
            ...
            'start_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 12, 16, 0, 0)'}),
            'url': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
