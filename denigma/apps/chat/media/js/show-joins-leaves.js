...
var chatCookieName = 'chat-hide-joins-leaves';
...
var showJoinsAndLeaves = function() {
    var at = ('; ' + document.cookie).indexOf('; ' + chatCookieName + '=');
    var cookieValue = '';
    if (at > -1) {
        at += chatCookieName.length + 1;
...
$(function() {
    ...
    joinsLeavesCheckbox.change(function() {
        ...
        document.cookie = chatCookieName + '=' + cookieValue + '; path=/';
