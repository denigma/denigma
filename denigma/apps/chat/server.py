...
from chat.client import WebSocketIRCClient
...
class IRCApplication(object):
    ...
    def index(self):
        ...
        template_dir = os.path.join(root_dir, "templates", "chat")
    ...
    def authorized(self, environ):
        """If we're running Django and ``CHAT_LOGIN_REQUIRED`` is set
    ...
    def __call__(self, environ, start_response):
        ...
        headers.append(("Server", settings.CHAT_VERSION_STRING))
