...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'links.link': {
            ...
            'categories': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'links'", 'null': 'True', 'to': "orm['data.Entry']"}),
