...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Link.contact'
        db.alter_column('links_link', 'contact', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'Link.contact'
        db.alter_column('links_link', 'contact', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
