...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Gene'
        db.create_table('annotations_gene', (
        ...
        db.send_create_signal('annotations', ['Gene'])

        # Adding M2M table for field classification on 'Gene'
        db.create_table('annotations_gene_classification', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('gene', models.ForeignKey(orm['annotations.gene'], null=False)),
            ('classification', models.ForeignKey(orm['annotations.classification'], null=False))
        ))
        db.create_unique('annotations_gene_classification', ['gene_id', 'classification_id'])

        # Adding model 'Classification'
        db.create_table('annotations_classification', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('shortcut', self.gf('django.db.models.fields.CharField')(max_length=5)),
        ))
        db.send_create_signal('annotations', ['Classification'])


    def backwards(self, orm):
        
        # Deleting model 'Gene'
        db.delete_table('annotations_gene')

        # Removing M2M table for field classification on 'Gene'
        db.delete_table('annotations_gene_classification')

        # Deleting model 'Classification'
        db.delete_table('annotations_classification')
