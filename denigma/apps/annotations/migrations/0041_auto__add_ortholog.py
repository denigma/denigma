...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Ortholog'
        db.create_table('annotations_ortholog', (
            ...
            ('ortholog_taxid', self.gf('django.db.models.fields.IntegerField')()),
            ('gene', self.gf('django.db.models.fields.IntegerField')()),
            ('gene_symbol', self.gf('django.db.models.fields.IntegerField')()),
            ('gene_taxid', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('annotations', ['Ortholog'])


    def backwards(self, orm):
        
        # Deleting model 'Ortholog'
        db.delete_table('annotations_ortholog')
    ...
    models = {
        ...
        'annotations.ortholog': {
            ...
            'gene_symbol': ('django.db.models.fields.IntegerField', [], {}),
