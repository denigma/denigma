...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('annotations_species', (
            ('taxid', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('short_name', self.gf('django.db.models.fields.CharField')(max_length=7, blank=True)),
            ('common_name', self.gf('django.db.models.fields.CharField')(max_length=14, blank=True)),
            ('alternative_names', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['annotations.Animal'])),
            ('latin_name', self.gf('django.db.models.fields.CharField')(max_length=25, blank=True)),
            ('latin_shortcut', self.gf('django.db.models.fields.CharField')(max_length=15, blank=True)),
            ('number_genes', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('annotations', ['Species'])

        # Adding model 'Animal'
        db.create_table('annotations_animal', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('alternative_names', self.gf('django.db.models.fields.CharField')(max_length=21, blank=True)),
            ('taxid', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('annotations', ['Animal'])


    def backwards(self, orm):
        
        # Deleting model 'Species'
        db.delete_table('annotations_species')

        # Deleting model 'Animal'
        db.delete_table('annotations_animal')
    ...
    models = {
        ...
        'annotations.species': {
            ...
            'alternative_names': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['annotations.Animal']"}),
