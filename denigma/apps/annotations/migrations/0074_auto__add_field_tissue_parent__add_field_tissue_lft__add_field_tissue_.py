...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Tissue.parent'
        db.add_column('annotations_tissue', 'parent',
                      self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['annotations.Tissue']),
                      keep_default=False)

        # Adding field 'Tissue.lft'
        db.add_column('annotations_tissue', 'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Tissue.rght'
        db.add_column('annotations_tissue', 'rght',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Tissue.tree_id'
        db.add_column('annotations_tissue', 'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Tissue.level'
        db.add_column('annotations_tissue', 'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Classification.parent'
        db.add_column('annotations_classification', 'parent',
                      self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['annotations.Classification']),
                      keep_default=False)

        # Adding field 'Classification.lft'
        db.add_column('annotations_classification', 'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Classification.rght'
        db.add_column('annotations_classification', 'rght',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Classification.tree_id'
        db.add_column('annotations_classification', 'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Classification.level'
        db.add_column('annotations_classification', 'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Tissue.parent'
        db.delete_column('annotations_tissue', 'parent_id')

        # Deleting field 'Tissue.lft'
        db.delete_column('annotations_tissue', 'lft')

        # Deleting field 'Tissue.rght'
        db.delete_column('annotations_tissue', 'rght')

        # Deleting field 'Tissue.tree_id'
        db.delete_column('annotations_tissue', 'tree_id')

        # Deleting field 'Tissue.level'
        db.delete_column('annotations_tissue', 'level')

        # Deleting field 'Classification.parent'
        db.delete_column('annotations_classification', 'parent_id')

        # Deleting field 'Classification.lft'
        db.delete_column('annotations_classification', 'lft')

        # Deleting field 'Classification.rght'
        db.delete_column('annotations_classification', 'rght')

        # Deleting field 'Classification.tree_id'
        db.delete_column('annotations_classification', 'tree_id')

        # Deleting field 'Classification.level'
        db.delete_column('annotations_classification', 'level')
    ...
    models = {
        ...
        'annotations.tissue': {
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'children'", 'null': 'True', 'to': "orm['annotations.Tissue']"}),
            'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
            'synonyms': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'tree_id': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'})
        },
