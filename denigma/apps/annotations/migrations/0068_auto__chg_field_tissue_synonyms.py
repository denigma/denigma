...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tissue.synonyms'
        db.alter_column('annotations_tissue', 'synonyms', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Tissue.synonyms'
        db.alter_column('annotations_tissue', 'synonyms', self.gf('django.db.models.fields.CharField')(max_length=255))
