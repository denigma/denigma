...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Entrez_Gene'
        db.create_table('annotations_entrez_gene', (
            ('entrez_gene_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('gene_symbol', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('gene_name', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ('locus_tag', self.gf('django.db.models.fields.CharField')(max_length=25, blank=True)),
            ('symbol_from_nomenclature_authority', self.gf('django.db.models.fields.CharField')(max_length=29, blank=True)),
            ...
            ('hgnc', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('mim', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('hprd', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('rgd', self.gf('django.db.models.fields.IntegerField')(blank=True)),
            ('ratmap', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
        ...
        db.send_create_signal('annotations', ['Entrez_Gene'])


    def backwards(self, orm):
        
        # Deleting model 'Entrez_Gene'
        db.delete_table('annotations_entrez_gene')
