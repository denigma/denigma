...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Regimen.shortcut'
        db.alter_column('annotations_regimen', 'shortcut', self.gf('django.db.models.fields.CharField')(max_length=20))


    def backwards(self, orm):
        
        # Changing field 'Regimen.shortcut'
        db.alter_column('annotations_regimen', 'shortcut', self.gf('django.db.models.fields.CharField')(max_length=10))
