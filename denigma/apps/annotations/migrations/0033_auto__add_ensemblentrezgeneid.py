...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EnsemblEntrezGeneId'
        db.create_table('annotations_ensemblentrezgeneid', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ensembl_gene_id', self.gf('django.db.models.fields.CharField')(max_length=18)),
            ('entrez_gene_id', self.gf('django.db.models.fields.IntegerField')()),
            ('taxid', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('annotations', ['EnsemblEntrezGeneId'])


    def backwards(self, orm):
        
        # Deleting model 'EnsemblEntrezGeneId'
        db.delete_table('annotations_ensemblentrezgeneid')
