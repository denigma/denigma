...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PotentialOrthologs_4932_10090.dn'
        db.add_column('annotations_potentialorthologs_4932_10090', 'dn', self.gf('django.db.models.fields.CharField')(default=2, max_length=1), keep_default=False)

        # Adding field 'PotentialOrthologs_4932_10090.ds'
        db.add_column('annotations_potentialorthologs_4932_10090', 'ds', self.gf('django.db.models.fields.CharField')(default=2, max_length=1), keep_default=False)

        # Adding field 'Orthologs_4932_6239.dn'
        db.add_column('annotations_orthologs_4932_6239', 'dn', self.gf('django.db.models.fields.CharField')(default=2, max_length=1), keep_default=False)

        # Adding field 'Orthologs_4932_6239.ds'
        db.add_column('annotations_orthologs_4932_6239', 'ds', self.gf('django.db.models.fields.CharField')(default=2, max_length=1), keep_default=False)

        # Adding field 'PotentialOrthologs_4932_6239.dn'
        db.add_column('annotations_potentialorthologs_4932_6239', 'dn', self.gf('django.db.models.fields.CharField')(default=2, max_length=1), keep_default=False)

        # Adding field 'PotentialOrthologs_4932_6239.ds'
        db.add_column('annotations_potentialorthologs_4932_6239', 'ds', self.gf('django.db.models.fields.CharField')(default=2, max_length=1), keep_default=False)

        # Adding field 'Orthologs_4932_7227.dn'
        db.add_column('annotations_orthologs_4932_7227', 'dn', self.gf('django.db.models.fields.CharField')(default=2, max_length=1), keep_default=False)

        # Adding field 'Orthologs_4932_7227.ds'
        db.add_column('annotations_orthologs_4932_7227', 'ds', self.gf('django.db.models.fields.CharField')(default=2, max_length=1), keep_default=False)

        # Adding field 'PotentialOrthologs_4932_7227.dn'
        db.add_column('annotations_potentialorthologs_4932_7227', 'dn', self.gf('django.db.models.fields.CharField')(default=2, max_length=1), keep_default=False)

        # Adding field 'PotentialOrthologs_4932_7227.ds'
        db.add_column('annotations_potentialorthologs_4932_7227', 'ds', self.gf('django.db.models.fields.CharField')(default=2, max_length=1), keep_default=False)

        # Adding field 'Paralogs_4932_4932.dn'
        db.add_column('annotations_paralogs_4932_4932', 'dn', self.gf('django.db.models.fields.CharField')(default=2, max_length=1), keep_default=False)

        # Adding field 'Paralogs_4932_4932.ds'
        db.add_column('annotations_paralogs_4932_4932', 'ds', self.gf('django.db.models.fields.CharField')(default=2, max_length=1), keep_default=False)

        # Adding field 'PotentialOrthologs_4932_9544.dn'
        db.add_column('annotations_potentialorthologs_4932_9544', 'dn', self.gf('django.db.models.fields.CharField')(default=2, max_length=1), keep_default=False)

        # Adding field 'PotentialOrthologs_4932_9544.ds'
        db.add_column('annotations_potentialorthologs_4932_9544', 'ds', self.gf('django.db.models.fields.CharField')(default=2, max_length=1), keep_default=False)

        # Adding field 'PotentialOrthologs_4932_9606.dn'
        db.add_column('annotations_potentialorthologs_4932_9606', 'dn', self.gf('django.db.models.fields.CharField')(default=2, max_length=1), keep_default=False)

        # Adding field 'PotentialOrthologs_4932_9606.ds'
        db.add_column('annotations_potentialorthologs_4932_9606', 'ds', self.gf('django.db.models.fields.CharField')(default=2, max_length=1), keep_default=False)

        # Adding field 'Orthologs_4932_10090.dn'
        db.add_column('annotations_orthologs_4932_10090', 'dn', self.gf('django.db.models.fields.CharField')(default=2, max_length=1), keep_default=False)

        # Adding field 'Orthologs_4932_10090.ds'
        db.add_column('annotations_orthologs_4932_10090', 'ds', self.gf('django.db.models.fields.CharField')(default=2, max_length=1), keep_default=False)

        # Adding field 'PotentialOrthologs_4932_10116.dn'
        db.add_column('annotations_potentialorthologs_4932_10116', 'dn', self.gf('django.db.models.fields.CharField')(default=2, max_length=1), keep_default=False)

        # Adding field 'PotentialOrthologs_4932_10116.ds'
        db.add_column('annotations_potentialorthologs_4932_10116', 'ds', self.gf('django.db.models.fields.CharField')(default=2, max_length=1), keep_default=False)

        # Adding field 'Orthologs_4932_9606.dn'
        db.add_column('annotations_orthologs_4932_9606', 'dn', self.gf('django.db.models.fields.CharField')(default=2, max_length=1), keep_default=False)

        # Adding field 'Orthologs_4932_9606.ds'
        db.add_column('annotations_orthologs_4932_9606', 'ds', self.gf('django.db.models.fields.CharField')(default=2, max_length=1), keep_default=False)

        # Adding field 'Orthologs_4932_9544.dn'
        db.add_column('annotations_orthologs_4932_9544', 'dn', self.gf('django.db.models.fields.CharField')(default=2, max_length=1), keep_default=False)

        # Adding field 'Orthologs_4932_9544.ds'
        db.add_column('annotations_orthologs_4932_9544', 'ds', self.gf('django.db.models.fields.CharField')(default=2, max_length=1), keep_default=False)

        # Adding field 'Orthologs_4932_10116.dn'
        db.add_column('annotations_orthologs_4932_10116', 'dn', self.gf('django.db.models.fields.CharField')(default=2, max_length=1), keep_default=False)

        # Adding field 'Orthologs_4932_10116.ds'
        db.add_column('annotations_orthologs_4932_10116', 'ds', self.gf('django.db.models.fields.CharField')(default=2, max_length=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PotentialOrthologs_4932_10090.dn'
        db.delete_column('annotations_potentialorthologs_4932_10090', 'dn')

        # Deleting field 'PotentialOrthologs_4932_10090.ds'
        db.delete_column('annotations_potentialorthologs_4932_10090', 'ds')

        # Deleting field 'Orthologs_4932_6239.dn'
        db.delete_column('annotations_orthologs_4932_6239', 'dn')

        # Deleting field 'Orthologs_4932_6239.ds'
        db.delete_column('annotations_orthologs_4932_6239', 'ds')

        # Deleting field 'PotentialOrthologs_4932_6239.dn'
        db.delete_column('annotations_potentialorthologs_4932_6239', 'dn')

        # Deleting field 'PotentialOrthologs_4932_6239.ds'
        db.delete_column('annotations_potentialorthologs_4932_6239', 'ds')

        # Deleting field 'Orthologs_4932_7227.dn'
        db.delete_column('annotations_orthologs_4932_7227', 'dn')

        # Deleting field 'Orthologs_4932_7227.ds'
        db.delete_column('annotations_orthologs_4932_7227', 'ds')

        # Deleting field 'PotentialOrthologs_4932_7227.dn'
        db.delete_column('annotations_potentialorthologs_4932_7227', 'dn')

        # Deleting field 'PotentialOrthologs_4932_7227.ds'
        db.delete_column('annotations_potentialorthologs_4932_7227', 'ds')

        # Deleting field 'Paralogs_4932_4932.dn'
        db.delete_column('annotations_paralogs_4932_4932', 'dn')

        # Deleting field 'Paralogs_4932_4932.ds'
        db.delete_column('annotations_paralogs_4932_4932', 'ds')

        # Deleting field 'PotentialOrthologs_4932_9544.dn'
        db.delete_column('annotations_potentialorthologs_4932_9544', 'dn')

        # Deleting field 'PotentialOrthologs_4932_9544.ds'
        db.delete_column('annotations_potentialorthologs_4932_9544', 'ds')

        # Deleting field 'PotentialOrthologs_4932_9606.dn'
        db.delete_column('annotations_potentialorthologs_4932_9606', 'dn')

        # Deleting field 'PotentialOrthologs_4932_9606.ds'
        db.delete_column('annotations_potentialorthologs_4932_9606', 'ds')

        # Deleting field 'Orthologs_4932_10090.dn'
        db.delete_column('annotations_orthologs_4932_10090', 'dn')

        # Deleting field 'Orthologs_4932_10090.ds'
        db.delete_column('annotations_orthologs_4932_10090', 'ds')

        # Deleting field 'PotentialOrthologs_4932_10116.dn'
        db.delete_column('annotations_potentialorthologs_4932_10116', 'dn')

        # Deleting field 'PotentialOrthologs_4932_10116.ds'
        db.delete_column('annotations_potentialorthologs_4932_10116', 'ds')

        # Deleting field 'Orthologs_4932_9606.dn'
        db.delete_column('annotations_orthologs_4932_9606', 'dn')

        # Deleting field 'Orthologs_4932_9606.ds'
        db.delete_column('annotations_orthologs_4932_9606', 'ds')

        # Deleting field 'Orthologs_4932_9544.dn'
        db.delete_column('annotations_orthologs_4932_9544', 'dn')

        # Deleting field 'Orthologs_4932_9544.ds'
        db.delete_column('annotations_orthologs_4932_9544', 'ds')

        # Deleting field 'Orthologs_4932_10116.dn'
        db.delete_column('annotations_orthologs_4932_10116', 'dn')

        # Deleting field 'Orthologs_4932_10116.ds'
        db.delete_column('annotations_orthologs_4932_10116', 'ds')
