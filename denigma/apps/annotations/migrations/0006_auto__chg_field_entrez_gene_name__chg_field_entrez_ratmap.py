...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Entrez.gene_name'
        db.alter_column('annotations_entrez', 'gene_name', self.gf('django.db.models.fields.TextField')())

        # Changing field 'Entrez.ratmap'
        db.alter_column('annotations_entrez', 'ratmap', self.gf('django.db.models.fields.CharField')(max_length=1))


    def backwards(self, orm):
        
        # Changing field 'Entrez.gene_name'
        db.alter_column('annotations_entrez', 'gene_name', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Entrez.ratmap'
        db.alter_column('annotations_entrez', 'ratmap', self.gf('django.db.models.fields.IntegerField')())
