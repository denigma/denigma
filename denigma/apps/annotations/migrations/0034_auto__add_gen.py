...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Gen'
        db.create_table('annotations_gen', (
            ...
            ('gene_name', self.gf('django.db.models.fields.CharField')(max_length=173, blank=True)),
            ('taxid', self.gf('django.db.models.fields.IntegerField')()),
            ('classification', self.gf('django.db.models.fields.CharField')(max_length=33)),
            ('ageing_associated', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('positive_gerontogene', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('negative_gerontogene', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('positive_ageing_suppressor', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('negative_ageing_suppressor', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('longevity_associated', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('ageing_differential', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('ageing_induced', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('ageing_suppressed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('dr_essential', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('dr_differential', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('dr_induced', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('dr_suppressed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('core_clock', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('clock_modulator', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('circadian_differential', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('clock_systemic', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('juvenile_differential', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('juvenile_induced', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('juvenile_suppressed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('embryonic_lethal', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('senescence_differential', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('senescence_induced', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('senescence_suppressed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('gerontogene', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('ageing_suppressor', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('imprinted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('maternal_imprinted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('paternal_imprinted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('transcription_factor', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('pacemaker', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('high_amplitude', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('short_period', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('long_period', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('juvenile_associated', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('ageing_methylated', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('dr_essential_ortholog', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('clock_modulator_ortholog', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('annotations', ['Gen'])


    def backwards(self, orm):
        
        # Deleting model 'Gen'
        db.delete_table('annotations_gen')
