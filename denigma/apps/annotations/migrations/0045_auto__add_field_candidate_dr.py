...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Candidate.dr'
        db.add_column(u'Candidate', 'dr', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Candidate.dr'
        db.delete_column(u'Candidate', 'dr')
