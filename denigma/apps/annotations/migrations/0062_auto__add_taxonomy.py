...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'taxonomy', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('superkingdom', self.gf('django.db.models.fields.CharField')(max_length=54, blank=True)),
            ('tribe', self.gf('django.db.models.fields.CharField')(max_length=87, blank=True)),
            ('litter_rate', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('subgenus', self.gf('django.db.models.fields.CharField')(max_length=93, blank=True)),
            ('acronyms', self.gf('django.db.models.fields.CharField')(max_length=147, blank=True)),
            ('family', self.gf('django.db.models.fields.CharField')(max_length=129, blank=True)),
            ('adult_weight', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('scientific_name', self.gf('django.db.models.fields.CharField')(max_length=324, blank=True)),
            ('litters_size', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('synonyms', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('phylum', self.gf('django.db.models.fields.CharField')(max_length=102, blank=True)),
            ('superclass', self.gf('django.db.models.fields.CharField')(max_length=45, blank=True)),
            ('body_mass', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('classis', self.gf('django.db.models.fields.CharField')(max_length=84, blank=True)),
            ('specimen_origin', self.gf('django.db.models.fields.CharField')(max_length=27, blank=True)),
            ('subspecies', self.gf('django.db.models.fields.CharField')(max_length=111, blank=True)),
            ('genbank_anamorph', self.gf('django.db.models.fields.CharField')(max_length=117, blank=True)),
            ('genbank_synonym', self.gf('django.db.models.fields.CharField')(max_length=168, blank=True)),
            ('ordo', self.gf('django.db.models.fields.CharField')(max_length=129, blank=True)),
            ('forma', self.gf('django.db.models.fields.CharField')(max_length=135, blank=True)),
            ('common_names', self.gf('django.db.models.fields.CharField')(max_length=534, blank=True)),
            ('misnomers', self.gf('django.db.models.fields.CharField')(max_length=687, blank=True)),
            ('inter_litters', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('infraorder', self.gf('django.db.models.fields.CharField')(max_length=54, blank=True)),
            ('subclass', self.gf('django.db.models.fields.CharField')(max_length=93, blank=True)),
            ('equivalent_names', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('source', self.gf('django.db.models.fields.CharField')(max_length=129, blank=True)),
            ('imr', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('superphylum', self.gf('django.db.models.fields.CharField')(max_length=24, blank=True)),
            ('metabolic_rate', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('species_subgroup', self.gf('django.db.models.fields.CharField')(max_length=84, blank=True)),
            ('anamorphs', self.gf('django.db.models.fields.CharField')(max_length=213, blank=True)),
            ('growth_rate', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('kingdom', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('mrdt', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('weaning_weight', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('genbank_acronym', self.gf('django.db.models.fields.CharField')(max_length=66, blank=True)),
            ('subtribe', self.gf('django.db.models.fields.CharField')(max_length=87, blank=True)),
            ('weaning_days', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('genbank_common_name', self.gf('django.db.models.fields.CharField')(max_length=171, blank=True)),
            ('subphylum', self.gf('django.db.models.fields.CharField')(max_length=93, blank=True)),
            ('subkingdom', self.gf('django.db.models.fields.CharField')(max_length=15, blank=True)),
            ('unpublished_names', self.gf('django.db.models.fields.CharField')(max_length=381, blank=True)),
            ('gestation', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('includes', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('infraclass', self.gf('django.db.models.fields.CharField')(max_length=42, blank=True)),
            ('male_maturity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('varietas', self.gf('django.db.models.fields.CharField')(max_length=141, blank=True)),
            ('no_rank', self.gf('django.db.models.fields.CharField')(max_length=204, blank=True)),
            ('teleomorph', self.gf('django.db.models.fields.CharField')(max_length=117, blank=True)),
            ('reference', self.gf('django.db.models.fields.CharField')(max_length=531, blank=True)),
            ('authorities', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('subfamily', self.gf('django.db.models.fields.CharField')(max_length=57, blank=True)),
            ('female_maturity', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('in_parts', self.gf('django.db.models.fields.CharField')(max_length=366, blank=True)),
            ('superorder', self.gf('django.db.models.fields.CharField')(max_length=54, blank=True)),
            ('superfamily', self.gf('django.db.models.fields.CharField')(max_length=84, blank=True)),
            ('birth_weight', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('taxid', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('blast_name', self.gf('django.db.models.fields.CharField')(max_length=75, blank=True)),
            ('maximum_longevity', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('sample_size', self.gf('django.db.models.fields.CharField')(max_length=18, blank=True)),
            ('parvorder', self.gf('django.db.models.fields.CharField')(max_length=42, blank=True)),
            ('species_group', self.gf('django.db.models.fields.CharField')(max_length=84, blank=True)),
            ('data_quality', self.gf('django.db.models.fields.CharField')(max_length=36, blank=True)),
            ('suborder', self.gf('django.db.models.fields.CharField')(max_length=93, blank=True)),
            ('species', self.gf('django.db.models.fields.CharField')(max_length=228, blank=True)),
            ('genus', self.gf('django.db.models.fields.CharField')(max_length=147, blank=True)),
            ('temperature', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('misspellings', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('annotations', ['Taxonomy'])


    def backwards(self, orm):
        
        # Deleting model 'Taxonomy'
        db.delete_table(u'taxonomy')
