...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Regimen.name'
        db.alter_column('annotations_regimen', 'name', self.gf('django.db.models.fields.CharField')(max_length=40))


    def backwards(self, orm):
        
        # Changing field 'Regimen.name'
        db.alter_column('annotations_regimen', 'name', self.gf('django.db.models.fields.CharField')(max_length=20))
