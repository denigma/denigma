...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'HomoloGene'
        db.create_table('annotations_homologene', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('hid', self.gf('django.db.models.fields.IntegerField')()),
            ('taxid', self.gf('django.db.models.fields.IntegerField')()),
            ('entrez_gene_id', self.gf('django.db.models.fields.IntegerField')()),
            ('gene_symbol', self.gf('django.db.models.fields.CharField')(max_length=42)),
        ...
        db.send_create_signal('annotations', ['HomoloGene'])


    def backwards(self, orm):
        
        # Deleting model 'HomoloGene'
        db.delete_table('annotations_homologene')
