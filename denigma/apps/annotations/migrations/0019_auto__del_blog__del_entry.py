...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting model 'Blog'
        db.delete_table('annotations_blog')

        # Removing M2M table for field entry on 'Blog'
        db.delete_table('annotations_blog_entry')

        # Deleting model 'Entry'
        db.delete_table('annotations_entry')


    def backwards(self, orm):
        
        # Adding model 'Blog'
        db.create_table('annotations_blog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('annotations', ['Blog'])

        # Adding M2M table for field entry on 'Blog'
        db.create_table('annotations_blog_entry', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('blog', models.ForeignKey(orm['annotations.blog'], null=False)),
            ('entry', models.ForeignKey(orm['annotations.entry'], null=False))
        ))
        db.create_unique('annotations_blog_entry', ['blog_id', 'entry_id'])

        # Adding model 'Entry'
        db.create_table('annotations_entry', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=10)),
        ))
        db.send_create_signal('annotations', ['Entry'])
