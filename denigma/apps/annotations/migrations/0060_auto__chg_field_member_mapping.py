...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'member.mapping'
        db.alter_column('annotations_member', 'mapping', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'member.mapping'
        db.alter_column('annotations_member', 'mapping', self.gf('django.db.models.fields.BooleanField')())
