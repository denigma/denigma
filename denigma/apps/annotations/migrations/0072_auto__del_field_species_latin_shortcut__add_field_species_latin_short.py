...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Species.latin_shortcut'
        db.rename_column('annotations_species', 'latin_shortcut', 'short_latin_name')


    def backwards(self, orm):
        # Renaming field 'Species.latin_shortcut'
        db.rename_column('annotations_species', 'short_latin_name', 'latin_shortcut')
    ...
    models = {
        ...
        'annotations.species': {
            ...
            'latin_short': ('django.db.models.fields.CharField', [], {'max_length': '15', 'blank': 'True'}),
