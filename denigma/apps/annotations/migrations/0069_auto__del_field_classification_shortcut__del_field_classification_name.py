...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Classification.shortcut' into 'Classficiation.abbreviation'
        db.rename_column('annotations_classification', 'shortcut', 'abbreviation')

        # Renaming field 'Classification.name' into 'Classification.slug'
        db.rename_column('annotations_classification', 'name', 'slug')

        # Adding field 'Classification.description'
        db.add_column('annotations_classification', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Renaming field 'Classification.abbreviation' into 'Classification.shortcut'
        db.rename_column('annotations_classification', 'abbreviation', 'shortcut')

        # Renaming field 'Classification.slug' into 'Classification.name'
        db.rename_column('annotations_classification', 'slug', 'name')

        # Deleting field 'Classification.description'
        db.delete_column('annotations_classification', 'description')
