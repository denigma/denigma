...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Species.alternative_names'
        db.delete_column('annotations_species', 'alternative_names_id')

        # Adding M2M table for field alternative_names on 'Species'
        db.create_table('annotations_species_alternative_names', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('species', models.ForeignKey(orm['annotations.species'], null=False)),
            ('animal', models.ForeignKey(orm['annotations.animal'], null=False))
        ))
        db.create_unique('annotations_species_alternative_names', ['species_id', 'animal_id'])


    def backwards(self, orm):
        
        # Adding field 'Species.alternative_names'
        db.add_column('annotations_species', 'alternative_names', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['annotations.Animal']), keep_default=False)

        # Removing M2M table for field alternative_names on 'Species'
        db.delete_table('annotations_species_alternative_names')
