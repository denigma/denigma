...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('annotations_member', (
            ...
            ('member_id', self.gf('django.db.models.fields.CharField')(max_length=49)),
            ...
            ('genome_db_id', self.gf('django.db.models.fields.CharField')(max_length=4)),
    ...
    models = {
        ...
        'annotations.member': {
            ...
            'genome_db_id': ('django.db.models.fields.CharField', [], {'max_length': '4'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member_id': ('django.db.models.fields.CharField', [], {'max_length': '49'}),
