...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Species.main_model'
        db.add_column('annotations_species', 'main_model',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Species.main_model'
        db.delete_column('annotations_species', 'main_model')
