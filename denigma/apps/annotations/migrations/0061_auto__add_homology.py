...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'homology'
        db.create_table('annotations_homology', (
            ('homology_id', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('stable_id', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('method_link_species_set_id', self.gf('django.db.models.fields.IntegerField')()),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('subtype', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ...
            ('lnl', self.gf('django.db.models.fields.FloatField')()),
            ('threshold_on_ds', self.gf('django.db.models.fields.FloatField')()),
            ('ancestor_node_id', self.gf('django.db.models.fields.IntegerField')()),
            ('tree_node_id', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('annotations', ['homology'])


    def backwards(self, orm):
        
        # Deleting model 'homology'
        db.delete_table('annotations_homology')
    ...
    models = {
        ...
        'annotations.homology': {
            'Meta': {'object_name': 'homology'},
            'ancestor_node_id': ('django.db.models.fields.IntegerField', [], {}),
            ...
            'homology_id': ('django.db.models.fields.IntegerField', [], {'primary_key': 'True'}),
            'lnl': ('django.db.models.fields.FloatField', [], {}),
            'method_link_species_set_id': ('django.db.models.fields.IntegerField', [], {}),
            'n': ('django.db.models.fields.FloatField', [], {}),
            's': ('django.db.models.fields.FloatField', [], {}),
            'stable_id': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'subtype': ('django.db.models.fields.CharField', [], {'max_length': '40'}),
            'threshold_on_ds': ('django.db.models.fields.FloatField', [], {}),
            'tree_node_id': ('django.db.models.fields.IntegerField', [], {})
        },
        ...
        'annotations.member': {
            ...
            'chr_end': ('django.db.models.fields.IntegerField', [], {}),
            'chr_name': ('django.db.models.fields.CharField', [], {'max_length': '27'}),
            'chr_start': ('django.db.models.fields.IntegerField', [], {}),
            'chr_strand': ('django.db.models.fields.IntegerField', [], {}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'display_label': ('django.db.models.fields.CharField', [], {'max_length': '12'}),
            'entrez_gene_id': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'gene_member_id': ('django.db.models.fields.IntegerField', [], {}),
            'genome_db_id': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'mapping': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'member_id': ('django.db.models.fields.IntegerField', [], {}),
            'sequence_id': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'source_name': ('django.db.models.fields.CharField', [], {'max_length': '17'}),
            'stable_id': ('django.db.models.fields.CharField', [], {'max_length': '19'}),
            'taxon_id': ('django.db.models.fields.IntegerField', [], {}),
