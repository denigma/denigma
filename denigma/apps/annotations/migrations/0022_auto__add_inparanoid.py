...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'InParanoid'
        db.create_table('annotations_inparanoid', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('group_number', self.gf('django.db.models.fields.IntegerField')()),
            ('entrez_gene_id_a', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('entrez_gene_id_b', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('taxid_a', self.gf('django.db.models.fields.IntegerField')()),
            ('taxid_b', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('annotations', ['InParanoid'])


    def backwards(self, orm):
        
        # Deleting model 'InParanoid'
        db.delete_table('annotations_inparanoid')
    ...
    models = {
        ...
        'annotations.inparanoid': {
            ...
            'entrez_gene_id_a': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'entrez_gene_id_b': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
