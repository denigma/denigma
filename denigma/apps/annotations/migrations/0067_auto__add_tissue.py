...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Tissue'
        db.create_table('annotations_tissue', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('synonyms', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('hierarchy', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('identifier', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal('annotations', ['Tissue'])


    def backwards(self, orm):
        # Deleting model 'Tissue'
        db.delete_table('annotations_tissue')
