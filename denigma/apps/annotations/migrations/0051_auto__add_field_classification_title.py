...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Classification.title'
        db.add_column('annotations_classification', 'title', self.gf('django.db.models.fields.CharField')(default=1, max_length=30), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Classification.title'
        db.delete_column('annotations_classification', 'title')
