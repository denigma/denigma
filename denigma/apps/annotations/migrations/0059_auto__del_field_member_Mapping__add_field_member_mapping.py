...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'member.Mapping'
        db.delete_column('annotations_member', 'Mapping')

        # Adding field 'member.mapping'
        db.add_column('annotations_member', 'mapping', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
