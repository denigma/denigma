...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Species.description'
        db.add_column('annotations_species', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'Species.complexity'
        db.add_column('annotations_species', 'complexity',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field images on 'Species'
        ...
        # Adding M2M table for field images on 'Taxonomy'
        ...
        # Adding M2M table for field images on 'Tissue'
    ...
    def backwards(self, orm):
        # Deleting field 'Species.description'
        db.delete_column('annotations_species', 'description')

        # Deleting field 'Species.complexity'
        db.delete_column('annotations_species', 'complexity')

        # Removing M2M table for field images on 'Species'
        db.delete_table('annotations_species_images')

        # Removing M2M table for field images on 'Taxonomy'
        db.delete_table('taxonomy_images')

        # Removing M2M table for field images on 'Tissue'
        db.delete_table('annotations_tissue_images')
