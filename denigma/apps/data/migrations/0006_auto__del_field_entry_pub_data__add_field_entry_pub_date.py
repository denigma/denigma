...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Entry.pub_data'
        db.delete_column('data_entry', 'pub_data')

        # Adding field 'Entry.pub_date'
        db.add_column('data_entry', 'pub_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Entry.pub_data'
        db.add_column('data_entry', 'pub_data',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Entry.pub_date'
        db.delete_column('data_entry', 'pub_date')
