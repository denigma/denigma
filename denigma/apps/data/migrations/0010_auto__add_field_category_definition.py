...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('data_category', 'definition',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'category', null=True, to=orm['data.Entry']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.definition'
        db.delete_column('data_category', 'definition_id')
