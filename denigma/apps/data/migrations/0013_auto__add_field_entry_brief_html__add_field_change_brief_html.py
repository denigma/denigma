...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Entry.brief_html'
        db.add_column('data_entry', 'brief_html',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Change.brief_html'
        db.add_column('data_change', 'brief_html',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Entry.brief_html'
        db.delete_column('data_entry', 'brief_html')

        # Deleting field 'Change.brief_html'
        db.delete_column('data_change', 'brief_html')
