...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('data_tag', 'name', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255))
        # Adding unique constraint on 'Tag', fields ['name']
        db.create_unique('data_tag', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Tag', fields ['name']
        db.delete_unique('data_tag', ['name'])


        # Changing field 'Tag.name'
        db.alter_column('data_tag', 'name', self.gf('django.db.models.fields.CharField')(max_length=250))
