...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Change.slug'
        db.alter_column('data_change', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=255))

        # Changing field 'Entry.slug'
        db.alter_column('data_entry', 'slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=255))

    def backwards(self, orm):

        # Changing field 'Change.slug'
        db.alter_column('data_change', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))

        # Changing field 'Entry.slug'
        db.alter_column('data_entry', 'slug', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True))
