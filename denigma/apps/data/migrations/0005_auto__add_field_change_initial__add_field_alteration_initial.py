...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Change.initial'
        db.add_column('data_change', 'initial',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Alteration.initial'
        db.add_column('data_alteration', 'initial',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Change.initial'
        db.delete_column('data_change', 'initial')

        # Deleting field 'Alteration.initial'
        db.delete_column('data_alteration', 'initial')
    ...
    models = {
        ...
        'data.entry': {
            ...
            'pub_data': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
