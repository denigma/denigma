...
from views import Entries, EntryList, EntryView,  EntryCreate, EntryUpdate, EntryDelete, Generate,\
                  ...
                  TagDetail, TagList, \
                  HierarchyList, VivaGraph#, DictionaryView
...
urlpatterns = patterns('data.views',
    ...
    url(r'^entry/table/$', login_required(Entries.as_view(template_name='data/entry_table.html')),
        name='entry-table'),
   ...
   url(r'download/(?P<slug>.+)', 'download', name='download')
