...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Factor.pdb'
        db.alter_column('lifespan_factor', 'pdb', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

    def backwards(self, orm):

        # Changing field 'Factor.pdb'
        db.alter_column('lifespan_factor', 'pdb', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
