...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lifespan_comparison', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('exp', self.gf('django.db.models.fields.related.ForeignKey')(related_name='experimental_group', to=orm['lifespan.Measurement'])),
            ('ctr', self.gf('django.db.models.fields.related.ForeignKey')(related_name='control_group', to=orm['lifespan.Measurement'])),
        ...
        db.send_create_signal('lifespan', ['Comparison'])
    ...
    def backwards(self, orm):
        ...
        db.delete_table('lifespan_comparison')
    ...
    models = {
        ...
        'lifespan.measurement': {
            ...
            'comparisions': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['lifespan.Measurement']", 'through': "orm['lifespan.Comparison']", 'symmetrical': 'False'}),
