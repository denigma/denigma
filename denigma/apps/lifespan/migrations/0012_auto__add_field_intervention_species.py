...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Intervention.species'
        db.add_column('lifespan_intervention', 'species',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['annotations.Species'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Intervention.species'
        db.delete_column('lifespan_intervention', 'species_id')
