...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Variant.longer_lived_allele'
        db.add_column('lifespan_variant', 'longer_lived_allele',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Variant.longer_lived_allele'
        db.delete_column('lifespan_variant', 'longer_lived_allele')
    ...
    models = {
        ...
        'lifespan.variant': {
            ...
            'choice': ('django.db.models.fields.related.ForeignKey', [], {'default': '1', 'to': "orm['lifespan.State']"}),
