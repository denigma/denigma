...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Factor.symbol'
        db.alter_column('lifespan_factor', 'symbol', self.gf('django.db.models.fields.CharField')(max_length=25))

    def backwards(self, orm):

        # Changing field 'Factor.symbol'
        db.alter_column('lifespan_factor', 'symbol', self.gf('django.db.models.fields.CharField')(max_length=15))
