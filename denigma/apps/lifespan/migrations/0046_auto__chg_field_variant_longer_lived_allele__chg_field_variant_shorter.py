...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Variant.longer_lived_allele'
        db.alter_column('lifespan_variant', 'longer_lived_allele', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

        # Changing field 'Variant.shorter_lived_allele'
        db.alter_column('lifespan_variant', 'shorter_lived_allele', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'Variant.longer_lived_allele'
        db.alter_column('lifespan_variant', 'longer_lived_allele', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

        # Changing field 'Variant.shorter_lived_allele'
        db.alter_column('lifespan_variant', 'shorter_lived_allele', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))
