...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Variant.polymorphism'
        db.alter_column('lifespan_variant', 'polymorphism', self.gf('django.db.models.fields.CharField')(max_length=20))
    ...
    models = {
        ...
        'lifespan.variant': {
            ...
            'polymorphism': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
