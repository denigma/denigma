...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Variant.qvalue'
        db.add_column('lifespan_variant', 'qvalue',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Variant.polymorphism'
        db.alter_column('lifespan_variant', 'polymorphism', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):
        # Deleting field 'Variant.qvalue'
        db.delete_column('lifespan_variant', 'qvalue')


        # Changing field 'Variant.polymorphism'
        db.alter_column('lifespan_variant', 'polymorphism', self.gf('django.db.models.fields.CharField')(max_length=250))
    ...
    models = {
        ...
        'lifespan.variant': {
            ...
            'factor': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'variant'", 'null': 'True', 'to': "orm['lifespan.Factor']"}),
            'factors': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'variance'", 'null': 'True', 'symmetrical': 'False', 'to': "orm['lifespan.Factor']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'longer_lived_allele': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
            ...
            'significant': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
