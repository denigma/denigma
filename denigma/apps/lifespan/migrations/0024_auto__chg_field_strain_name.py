...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Strain.name'
        db.alter_column('lifespan_strain', 'name', self.gf('django.db.models.fields.CharField')(max_length=50))

    def backwards(self, orm):

        # Changing field 'Strain.name'
        db.alter_column('lifespan_strain', 'name', self.gf('django.db.models.fields.CharField')(max_length=25))
