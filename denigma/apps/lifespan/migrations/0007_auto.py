...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field species on 'Study'
        db.create_table('lifespan_study_species', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('study', models.ForeignKey(orm['lifespan.study'], null=False)),
            ('species', models.ForeignKey(orm['annotations.species'], null=False))
        ))
        db.create_unique('lifespan_study_species', ['study_id', 'species_id'])


    def backwards(self, orm):
        # Removing M2M table for field species on 'Study'
        db.delete_table('lifespan_study_species')
