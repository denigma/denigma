...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Intervention.strain'
        db.add_column('lifespan_intervention', 'strain',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lifespan.Strain'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Intervention.strain'
        db.delete_column('lifespan_intervention', 'strain_id')
