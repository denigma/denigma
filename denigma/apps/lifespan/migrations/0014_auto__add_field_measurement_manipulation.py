...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Measurement.manipulation'
        db.add_column('lifespan_measurement', 'manipulation',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lifespan.Manipulation'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Measurement.manipulation'
        db.delete_column('lifespan_measurement', 'manipulation_id')
