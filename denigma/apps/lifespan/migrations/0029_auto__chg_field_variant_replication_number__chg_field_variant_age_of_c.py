...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Variant.replication_number'
        db.alter_column('lifespan_variant', 'replication_number', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'Variant.age_of_cases'
        db.alter_column('lifespan_variant', 'age_of_cases', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

        # Changing field 'Variant.initial_number'
        db.alter_column('lifespan_variant', 'initial_number', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))

    def backwards(self, orm):

        # Changing field 'Variant.replication_number'
        db.alter_column('lifespan_variant', 'replication_number', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Variant.age_of_cases'
        db.alter_column('lifespan_variant', 'age_of_cases', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Variant.initial_number'
        db.alter_column('lifespan_variant', 'initial_number', self.gf('django.db.models.fields.TextField')(null=True))
