...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Factor.pdb'
        db.add_column('lifespan_factor', 'pdb',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Factor.pdb'
        db.delete_column('lifespan_factor', 'pdb')
    ...
    models = {
        ...
        'lifespan.factor': {
            ...
            'pdb': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
