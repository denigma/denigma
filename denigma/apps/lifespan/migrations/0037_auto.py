...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field classifications on 'Variant'
        db.create_table('lifespan_variant_classifications', (
        ...
        db.create_unique('lifespan_variant_classifications', ['variant_id', 'classification_id'])


    def backwards(self, orm):
        # Removing M2M table for field classifications on 'Variant'
        db.delete_table('lifespan_variant_classifications')
