...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Strain.species'
        db.alter_column('lifespan_strain', 'species_id', self.gf('django.db.models.fields.related.ForeignKey')(default=4932, to=orm['annotations.Species']))

    def backwards(self, orm):

        # Changing field 'Strain.species'
        db.alter_column('lifespan_strain', 'species_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['annotations.Species'], null=True))
