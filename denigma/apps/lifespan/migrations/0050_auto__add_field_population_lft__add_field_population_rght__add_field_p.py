...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Population.lft'
        db.add_column('lifespan_population', 'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Population.rght'
        db.add_column('lifespan_population', 'rght',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Population.tree_id'
        db.add_column('lifespan_population', 'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Population.level'
        db.add_column('lifespan_population', 'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Population.lft'
        db.delete_column('lifespan_population', 'lft')

        # Deleting field 'Population.rght'
        db.delete_column('lifespan_population', 'rght')

        # Deleting field 'Population.tree_id'
        db.delete_column('lifespan_population', 'tree_id')

        # Deleting field 'Population.level'
        db.delete_column('lifespan_population', 'level')
