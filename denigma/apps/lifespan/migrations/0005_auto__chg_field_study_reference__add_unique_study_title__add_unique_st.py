...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Study.reference'
        db.alter_column('lifespan_study', 'reference_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datasets.Reference'], null=True))
        # Adding unique constraint on 'Study', fields ['title']
        db.create_unique('lifespan_study', ['title'])

        # Adding unique constraint on 'Study', fields ['pmid']
        db.create_unique('lifespan_study', ['pmid'])


    def backwards(self, orm):
        # Removing unique constraint on 'Study', fields ['pmid']
        db.delete_unique('lifespan_study', ['pmid'])

        # Removing unique constraint on 'Study', fields ['title']
        db.delete_unique('lifespan_study', ['title'])


        # Changing field 'Study.reference'
        db.alter_column('lifespan_study', 'reference_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['datasets.Reference']))
