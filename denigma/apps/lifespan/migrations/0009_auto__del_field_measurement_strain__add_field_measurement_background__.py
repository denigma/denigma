...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Measurement.strain'
        db.delete_column('lifespan_measurement', 'strain_id')

        # Adding field 'Measurement.background'
        db.add_column('lifespan_measurement', 'background',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lifespan.Strain'], null=True, blank=True),
                      keep_default=False)


        # Renaming column for 'Measurement.genotype' to match new field type.
        db.rename_column('lifespan_measurement', 'genotype', 'genotype_id')
        # Changing field 'Measurement.genotype'
        db.alter_column('lifespan_measurement', 'genotype_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['lifespan.Strain']))
        # Adding index on 'Measurement', fields ['genotype']
        db.create_index('lifespan_measurement', ['genotype_id'])


    def backwards(self, orm):
        # Removing index on 'Measurement', fields ['genotype']
        db.delete_index('lifespan_measurement', ['genotype_id'])

        # Adding field 'Measurement.strain'
        db.add_column('lifespan_measurement', 'strain',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lifespan.Strain'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Measurement.background'
        db.delete_column('lifespan_measurement', 'background_id')


        # Renaming column for 'Measurement.genotype' to match new field type.
        db.rename_column('lifespan_measurement', 'genotype_id', 'genotype')
        # Changing field 'Measurement.genotype'
        db.alter_column('lifespan_measurement', 'genotype', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
