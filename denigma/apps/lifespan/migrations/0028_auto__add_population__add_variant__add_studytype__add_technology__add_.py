...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lifespan_population', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal('lifespan', ['Population'])

        # Adding model 'Variant'
        db.create_table('lifespan_variant', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('location', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('factor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lifespan.Factor'], null=True, blank=True)),
            ('polymorphism', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('choice', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lifespan.State'])),
            ('odds_ratio', self.gf('django.db.models.fields.FloatField')()),
            ('pvalue', self.gf('django.db.models.fields.FloatField')()),
            ('initial_number', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('replication_number', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('age_of_cases', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('technology', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lifespan.Technology'], null=True, blank=True)),
            ('study_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lifespan.StudyType'], null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('shorter_lived_allele', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('reference', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datasets.Reference'])),
        ))
        db.send_create_signal('lifespan', ['Variant'])

        # Adding M2M table for field ethnicity on 'Variant'
        db.create_table('lifespan_variant_ethnicity', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('variant', models.ForeignKey(orm['lifespan.variant'], null=False)),
            ('population', models.ForeignKey(orm['lifespan.population'], null=False))
        ))
        db.create_unique('lifespan_variant_ethnicity', ['variant_id', 'population_id'])

        # Adding model 'StudyType'
        db.create_table('lifespan_studytype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal('lifespan', ['StudyType'])

        # Adding model 'Technology'
        db.create_table('lifespan_technology', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal('lifespan', ['Technology'])

        # Adding model 'State'
        db.create_table('lifespan_state', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal('lifespan', ['State'])


    def backwards(self, orm):
        # Deleting model 'Population'
        db.delete_table('lifespan_population')

        # Deleting model 'Variant'
        db.delete_table('lifespan_variant')

        # Removing M2M table for field ethnicity on 'Variant'
        db.delete_table('lifespan_variant_ethnicity')

        # Deleting model 'StudyType'
        db.delete_table('lifespan_studytype')

        # Deleting model 'Technology'
        db.delete_table('lifespan_technology')

        # Deleting model 'State'
        db.delete_table('lifespan_state')
    ...
    models = {
        ...
        'lifespan.factor': {
            ...
            'symbol': ('django.db.models.fields.CharField', [], {'max_length': '15', 'blank': 'True'}),
        ...
        'lifespan.variant': {
            ...
            'age_of_cases': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'choice': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lifespan.State']"}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'ethnicity': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['lifespan.Population']", 'symmetrical': 'False'}),
            'factor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lifespan.Factor']", 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'initial_number': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'odds_ratio': ('django.db.models.fields.FloatField', [], {}),
            'polymorphism': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'pvalue': ('django.db.models.fields.FloatField', [], {}),
            'reference': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['datasets.Reference']"}),
            'replication_number': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'shorter_lived_allele': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),
