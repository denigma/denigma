...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Variant.pvalue'
        db.alter_column('lifespan_variant', 'pvalue', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):

        # Changing field 'Variant.pvalue'
        db.alter_column('lifespan_variant', 'pvalue', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
