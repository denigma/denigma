...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lifespan_varianttype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal('lifespan', ['VariantType'])

        # Adding model 'ORType'
        db.create_table('lifespan_ortype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
        ))
        db.send_create_signal('lifespan', ['ORType'])

        # Adding field 'Variant.variant_type'
        db.add_column('lifespan_variant', 'variant_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lifespan.VariantType'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Variant.or_type'
        db.add_column('lifespan_variant', 'or_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lifespan.ORType'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'VariantType'
        db.delete_table('lifespan_varianttype')

        # Deleting model 'ORType'
        db.delete_table('lifespan_ortype')

        # Deleting field 'Variant.variant_type'
        db.delete_column('lifespan_variant', 'variant_type_id')

        # Deleting field 'Variant.or_type'
        db.delete_column('lifespan_variant', 'or_type_id')
