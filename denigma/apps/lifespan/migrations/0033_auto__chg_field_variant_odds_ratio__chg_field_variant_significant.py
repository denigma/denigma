...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Variant.odds_ratio'
        db.alter_column('lifespan_variant', 'odds_ratio', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Variant.significant'
        db.alter_column('lifespan_variant', 'significant', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'Variant.odds_ratio'
        db.alter_column('lifespan_variant', 'odds_ratio', self.gf('django.db.models.fields.FloatField')(default=None))

        # Changing field 'Variant.significant'
        db.alter_column('lifespan_variant', 'significant', self.gf('django.db.models.fields.FloatField')(max_length=10, null=True))
