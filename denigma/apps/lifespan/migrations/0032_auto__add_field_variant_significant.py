...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Variant.significant'
        db.add_column('lifespan_variant', 'significant',
                      self.gf('django.db.models.fields.FloatField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Variant.significant'
        db.delete_column('lifespan_variant', 'significant')
    ...
    models = {
        ...
        'lifespan.variant': {
            ...
            'significant': ('django.db.models.fields.FloatField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
