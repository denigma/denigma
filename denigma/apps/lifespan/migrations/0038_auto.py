...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field factors on 'Variant'
        db.create_table('lifespan_variant_factors', (
        ...
        db.create_unique('lifespan_variant_factors', ['variant_id', 'factor_id'])


    def backwards(self, orm):
        # Removing M2M table for field factors on 'Variant'
        db.delete_table('lifespan_variant_factors')
