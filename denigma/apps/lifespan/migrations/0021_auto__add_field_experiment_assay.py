...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Experiment.assay'
        db.add_column('lifespan_experiment', 'assay',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=3, to=orm['lifespan.Assay']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Experiment.assay'
        db.delete_column('lifespan_experiment', 'assay_id')
