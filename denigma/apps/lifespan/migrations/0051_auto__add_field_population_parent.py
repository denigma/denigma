...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Population.parent'
        db.add_column('lifespan_population', 'parent',
                      self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='children', null=True, to=orm['lifespan.Population']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Population.parent'
        db.delete_column('lifespan_population', 'parent_id')
