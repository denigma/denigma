...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Variant.choice'
        db.alter_column('lifespan_variant', 'choice_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lifespan.State'], null=True))

    def backwards(self, orm):

        # Changing field 'Variant.choice'
        db.alter_column('lifespan_variant', 'choice_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lifespan.State']))
