...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lifespan_variant', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 6, 30, 0, 0), db_index=True, blank=True),
                      keep_default=False)

        # Adding field 'Variant.updated'
        db.add_column('lifespan_variant', 'updated',
    ...
    def backwards(self, orm):
        ...
        db.delete_column('lifespan_variant', 'created')

        # Deleting field 'Variant.updated'
        db.delete_column('lifespan_variant', 'updated')
    ...
    models = {
        ...
        'lifespan.factor': {
            ...
            'symbol': ('django.db.models.fields.CharField', [], {'max_length': '25', 'blank': 'True'}),
