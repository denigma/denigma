...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('lifespan_measurement', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('experiment', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lifespan.Experiment'])),
            ('control', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('strain', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lifespan.Strain'], null=True, blank=True)),
            ('genotype', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
            ('diet', self.gf('django.db.models.fields.CharField')(max_length=150, null=True, blank=True)),
            ('temperature', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('start', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('mean', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ...
        db.send_create_signal('lifespan', ['Measurement'])

        # Adding model 'Study'
        db.create_table('lifespan_study', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('reference', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['datasets.Reference'], blank=True)),
            ('notes', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('integrated', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal('lifespan', ['Study'])

        # Adding model 'Experiment'
        db.create_table('lifespan_experiment', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('data', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('study', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lifespan.Study'])),
            ('species', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['annotations.Species'])),
        ))
        db.send_create_signal('lifespan', ['Experiment'])

        # Adding model 'Strain'
        db.create_table('lifespan_strain', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=25)),
        ))
        db.send_create_signal('lifespan', ['Strain'])

        # Adding model 'Comparision'
        db.create_table('lifespan_comparision', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('experimental', self.gf('django.db.models.fields.related.ForeignKey')(related_name='experimental_group', to=orm['lifespan.Measurement'])),
            ('control', self.gf('django.db.models.fields.related.ForeignKey')(related_name='control_group', to=orm['lifespan.Measurement'])),
            ('epistasis', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lifespan.Epistasis'], null=True, blank=True)),
            ('intervention', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lifespan.Intervention'], null=True, blank=True)),
            ('mean', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('median', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('max', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal('lifespan', ['Comparision'])

        # Adding model 'Epistasis'
        db.create_table('lifespan_epistasis', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=20)),
        ))
        db.send_create_signal('lifespan', ['Epistasis'])


    def backwards(self, orm):
        # Deleting model 'Measurement'
        db.delete_table('lifespan_measurement')

        # Deleting model 'Study'
        db.delete_table('lifespan_study')

        # Deleting model 'Experiment'
        db.delete_table('lifespan_experiment')

        # Deleting model 'Strain'
        db.delete_table('lifespan_strain')

        # Deleting model 'Comparision'
        db.delete_table('lifespan_comparision')

        # Deleting model 'Epistasis'
        db.delete_table('lifespan_epistasis')
