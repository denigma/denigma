...
class FilterForm(Form):
    filter = CharField(required=False, help_text='Narrow results by variant, study, or associated fields:')
    term = CharField(required=False, help_text='Use <a href="/admin/annotations/go/">ontology terms</a> to further narrow results:')
