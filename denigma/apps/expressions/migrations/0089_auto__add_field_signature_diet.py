...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Signature.diet'
        db.add_column('expressions_signature', 'diet',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lifespan.Regimen'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Signature.diet'
        db.delete_column('expressions_signature', 'diet_id')
