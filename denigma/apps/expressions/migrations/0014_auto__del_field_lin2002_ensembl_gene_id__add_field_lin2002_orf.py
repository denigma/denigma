...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Lin2002.ensembl_gene_id'
        db.rename_column('expressions_lin2002', 'ensembl_gene_id', 'orf')

##        # Adding field 'Lin2002.orf'
##        db.add_column('expressions_lin2002', 'orf', self.gf('django.db.models.fields.CharField')(default=0, max_length=9), keep_default=False)
##

    def backwards(self, orm):
        
        # Adding field 'Lin2002.ensembl_gene_id'
        db.rename_column('expressions_lin2002', 'orf', 'ensembl_gene_id')

##        # Deleting field 'Lin2002.orf'
##        db.delete_column('expressions_lin2002', 'orf')
