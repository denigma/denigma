...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Rapamycin'
        db.create_table('expressions_rapamycin', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('orf', self.gf('django.db.models.fields.CharField')(max_length=9)),
            ('rapamycin_replicate_1', self.gf('django.db.models.fields.FloatField')()),
            ('rapamycin_replicate_2', self.gf('django.db.models.fields.FloatField')()),
            ('rapamycin_mean', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('fpr1_8_rapamycin_replicate_1', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('fpr1_8_rapamycin_replicate_2', self.gf('django.db.models.fields.FloatField')()),
            ('fpr1_8_rapamycin_replicate_3', self.gf('django.db.models.fields.FloatField')()),
            ('fpr1_8_rapamycin_mean', self.gf('django.db.models.fields.FloatField')()),
            ('ly_83583_replicate_1', self.gf('django.db.models.fields.FloatField')()),
            ('ly_83583_replicate_2', self.gf('django.db.models.fields.FloatField')()),
            ('ly_83583_mean', self.gf('django.db.models.fields.FloatField')(blank=True)),
        ))
        db.send_create_signal('expressions', ['Rapamycin'])


    def backwards(self, orm):
        
        # Deleting model 'Rapamycin'
        db.delete_table('expressions_rapamycin')
