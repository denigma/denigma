...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Profile.diet'
        db.alter_column('expressions_profile', 'diet_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lifespan.Regimen']))

    def backwards(self, orm):

        # Changing field 'Profile.diet'
        db.alter_column('expressions_profile', 'diet_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lifespan.Manipulation']))
