...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'miRNA_MSC_young'
        db.create_table('expressions_mirna_msc_young', (
            ...
            ('aveexpr', self.gf('django.db.models.fields.FloatField')()),
            ('t', self.gf('django.db.models.fields.FloatField')()),
            ('p_value', self.gf('django.db.models.fields.FloatField')()),
            ('adj_p_val', self.gf('django.db.models.fields.FloatField')()),
            ('b', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('expressions', ['miRNA_MSC_young'])

        # Adding model 'miRNA_young_old'
        db.create_table('expressions_mirna_young_old', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entrez_gene_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('mapping', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('identifier', self.gf('django.db.models.fields.IntegerField')()),
        ...
        db.send_create_signal('expressions', ['miRNA_young_old'])

        # Adding model 'miRNA_MSC_all'
        db.create_table('expressions_mirna_msc_all', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entrez_gene_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('mapping', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('identifier', self.gf('django.db.models.fields.IntegerField')()),
            ('gene_symbol', self.gf('django.db.models.fields.CharField')(max_length=17)),
            ('aveexpr', self.gf('django.db.models.fields.FloatField')()),
            ('t', self.gf('django.db.models.fields.FloatField')()),
            ('p_value', self.gf('django.db.models.fields.FloatField')()),
            ('adj_p_val', self.gf('django.db.models.fields.FloatField')()),
        ...
        db.send_create_signal('expressions', ['miRNA_MSC_all'])


    def backwards(self, orm):
        
        # Deleting model 'miRNA_MSC_young'
        db.delete_table('expressions_mirna_msc_young')

        # Deleting model 'miRNA_young_old'
        db.delete_table('expressions_mirna_young_old')

        # Deleting model 'miRNA_MSC_all'
        db.delete_table('expressions_mirna_msc_all')
