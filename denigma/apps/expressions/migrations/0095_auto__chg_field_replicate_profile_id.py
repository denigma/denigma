...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'Replicate.profile_id' to match new field type.
        db.rename_column('expressions_replicate', 'profile_id', 'profile_id_id')
        # Changing field 'Replicate.profile_id'
        db.alter_column('expressions_replicate', 'profile_id_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['expressions.Profile']))
        # Adding index on 'Replicate', fields ['profile_id']
        db.create_index('expressions_replicate', ['profile_id_id'])
    ...
    def backwards(self, orm):
        # Removing index on 'Replicate', fields ['profile_id']
        db.delete_index('expressions_replicate', ['profile_id_id'])


        # Renaming column for 'Replicate.profile_id' to match new field type.
        db.rename_column('expressions_replicate', 'profile_id_id', 'profile_id')
        # Changing field 'Replicate.profile_id'
        db.alter_column('expressions_replicate', 'profile_id', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'expressions.replicate': {
            ...
            'profile_id': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['expressions.Profile']"})
        },
