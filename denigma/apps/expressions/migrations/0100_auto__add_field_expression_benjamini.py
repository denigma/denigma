...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Expression.benjamini'
        db.add_column('expressions_expression', 'benjamini',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Expression.benjamini'
        db.delete_column('expressions_expression', 'benjamini')
