...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Germline_specific_genes'
        db.create_table('expressions_germline_specific_genes', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ensembl_id', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('symbol', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('germline_tags', self.gf('django.db.models.fields.IntegerField')()),
            ('in_situ', self.gf('django.db.models.fields.CharField')(max_length=3)),
            ('sage', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('microarray', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('rnai', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('descriptions', self.gf('django.db.models.fields.CharField')(max_length=65)),
        ))
        db.send_create_signal('expressions', ['Germline_specific_genes'])

        # Adding model 'germline_expressed_genes'
        db.create_table('expressions_germline_expressed_genes', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ensembl_id', self.gf('django.db.models.fields.CharField')(max_length=11)),
            ('symbol', self.gf('django.db.models.fields.CharField')(max_length=9)),
            ('chr', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('germline_tags', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('expressions', ['germline_expressed_genes'])


    def backwards(self, orm):
        
        # Deleting model 'Germline_specific_genes'
        db.delete_table('expressions_germline_specific_genes')

        # Deleting model 'germline_expressed_genes'
        db.delete_table('expressions_germline_expressed_genes')
