...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Rapamycin.fold_change'
        db.add_column('expressions_rapamycin', 'fold_change', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Adding field 'rapamycin_protein.orf'
        db.add_column('expressions_rapamycin_protein', 'orf', self.gf('django.db.models.fields.CharField')(default=None, max_length=9), keep_default=False)

        # Adding field 'rapamycin_protein.gene_symbol'
        db.add_column('expressions_rapamycin_protein', 'gene_symbol', self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Rapamycin.fold_change'
        db.delete_column('expressions_rapamycin', 'fold_change')

        # Deleting field 'rapamycin_protein.orf'
        db.delete_column('expressions_rapamycin_protein', 'orf')

        # Deleting field 'rapamycin_protein.gene_symbol'
        db.delete_column('expressions_rapamycin_protein', 'gene_symbol')
