...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PI3K'
        db.create_table('expressions_pi3k', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ensembl_id', self.gf('django.db.models.fields.CharField')(max_length=23, blank=True)),
            ('special', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('N2_sum', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('N2_average', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('N2_variance', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('hx_sum', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('hx_average', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('hx_variance', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('m_sum', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('m_average', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('m_variance', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('m_N2_fold_change', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('m_hx_fold_change', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('hx_N2_fold_change', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('m_N2_p_value', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('m_hx_p_value', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('hx_N2_p_value', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('log2', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('expressed', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('expressions', ['PI3K'])


    def backwards(self, orm):
        
        # Deleting model 'PI3K'
        db.delete_table('expressions_pi3k')
