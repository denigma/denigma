...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'YeastDR.dr_al'
        db.delete_column('expressions_yeastdr', 'dr_al')

        # Deleting field 'YeastDR.dr'
        db.delete_column('expressions_yeastdr', 'dr')

        # Adding field 'YeastDR.exp'
        db.add_column('expressions_yeastdr', 'exp', self.gf('django.db.models.fields.FloatField')(default=0), keep_default=False)

        # Adding field 'YeastDR.fold_change'
        db.add_column('expressions_yeastdr', 'fold_change', self.gf('django.db.models.fields.FloatField')(default=1), keep_default=False)

        # Deleting field 'WormDR.dr_al'
        db.delete_column('expressions_wormdr', 'dr_al')

        # Deleting field 'WormDR.dr'
        db.delete_column('expressions_wormdr', 'dr')

        # Deleting field 'WormDR.al'
        db.delete_column('expressions_wormdr', 'al')

        # Adding field 'WormDR.exp'
        db.add_column('expressions_wormdr', 'exp', self.gf('django.db.models.fields.FloatField')(default=1), keep_default=False)

        # Adding field 'WormDR.ctr'
        db.add_column('expressions_wormdr', 'ctr', self.gf('django.db.models.fields.FloatField')(default=1), keep_default=False)

        # Adding field 'WormDR.fold_change'
        db.add_column('expressions_wormdr', 'fold_change', self.gf('django.db.models.fields.FloatField')(default=1), keep_default=False)

        # Deleting field 'FlyDR_trn.dr'
        db.delete_column('expressions_flydr_trn', 'dr')

        # Deleting field 'FlyDR_trn.al'
        db.delete_column('expressions_flydr_trn', 'al')

        # Adding field 'FlyDR_trn.exp'
        db.add_column('expressions_flydr_trn', 'exp', self.gf('django.db.models.fields.FloatField')(default=1), keep_default=False)

        # Adding field 'FlyDR_trn.ctr'
        db.add_column('expressions_flydr_trn', 'ctr', self.gf('django.db.models.fields.FloatField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'YeastDR.dr_al'
        raise RuntimeError("Cannot reverse this migration. 'YeastDR.dr_al' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'YeastDR.dr'
        raise RuntimeError("Cannot reverse this migration. 'YeastDR.dr' and its values cannot be restored.")

        # Deleting field 'YeastDR.exp'
        db.delete_column('expressions_yeastdr', 'exp')

        # Deleting field 'YeastDR.fold_change'
        db.delete_column('expressions_yeastdr', 'fold_change')

        # User chose to not deal with backwards NULL issues for 'WormDR.dr_al'
        raise RuntimeError("Cannot reverse this migration. 'WormDR.dr_al' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'WormDR.dr'
        raise RuntimeError("Cannot reverse this migration. 'WormDR.dr' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'WormDR.al'
        raise RuntimeError("Cannot reverse this migration. 'WormDR.al' and its values cannot be restored.")

        # Deleting field 'WormDR.exp'
        db.delete_column('expressions_wormdr', 'exp')

        # Deleting field 'WormDR.ctr'
        db.delete_column('expressions_wormdr', 'ctr')

        # Deleting field 'WormDR.fold_change'
        db.delete_column('expressions_wormdr', 'fold_change')

        # User chose to not deal with backwards NULL issues for 'FlyDR_trn.dr'
        raise RuntimeError("Cannot reverse this migration. 'FlyDR_trn.dr' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'FlyDR_trn.al'
        raise RuntimeError("Cannot reverse this migration. 'FlyDR_trn.al' and its values cannot be restored.")

        # Deleting field 'FlyDR_trn.exp'
        db.delete_column('expressions_flydr_trn', 'exp')

        # Deleting field 'FlyDR_trn.ctr'
        db.delete_column('expressions_flydr_trn', 'ctr')
