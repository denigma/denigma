...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FlyDR_10day'
        db.create_table('expressions_flydr_10day', (
        ...
        db.send_create_signal('expressions', ['FlyDR_10day'])

        # Adding model 'FlyDR_40day'
        db.create_table('expressions_flydr_40day', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('probe_id', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('entrez_gene', self.gf('django.db.models.fields.CharField')(max_length=37, blank=True)),
            ('gene_symbol', self.gf('django.db.models.fields.CharField')(max_length=46, blank=True)),
        ...
        db.send_create_signal('expressions', ['FlyDR_40day'])


    def backwards(self, orm):
        
        # Deleting model 'FlyDR_10day'
        db.delete_table('expressions_flydr_10day')

        # Deleting model 'FlyDR_40day'
        db.delete_table('expressions_flydr_40day')
