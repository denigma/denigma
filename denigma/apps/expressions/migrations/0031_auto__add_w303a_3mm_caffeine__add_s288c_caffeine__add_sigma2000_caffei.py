...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'W303a_3mM_caffeine'
        db.create_table('expressions_w303a_3mm_caffeine', (
            ...
            ('go_component_id', self.gf('django.db.models.fields.TextField')(blank=True)),
            ...
            ('platform_orf', self.gf('django.db.models.fields.CharField')(max_length=9, blank=True)),
        ...
        db.send_create_signal('expressions', ['W303a_3mM_caffeine'])

        # Adding model 'S288c_caffeine'
        db.create_table('expressions_s288c_caffeine', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('probe_id', self.gf('django.db.models.fields.IntegerField')()),
            ('unigene_title', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ('nucleotide_title', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ...
            ('chromosome_annotation', self.gf('django.db.models.fields.CharField')(max_length=58, blank=True)),
            ('go_function', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('platform_orf', self.gf('django.db.models.fields.CharField')(max_length=9)),
            ('platform_cloneid', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ('go_process_id', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('genbank_accession', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ('gene_symbol', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
        ...
        db.send_create_signal('expressions', ['S288c_caffeine'])

        # Adding model 'Sigma2000_caffeine'
        db.create_table('expressions_sigma2000_caffeine', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('probe_id', self.gf('django.db.models.fields.IntegerField')()),
            ('unigene_title', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ('nucleotide_title', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
        ...
        db.send_create_signal('expressions', ['Sigma2000_caffeine'])

        # Adding model 'W303a_6mM_caffeine'
        db.create_table('expressions_w303a_6mm_caffeine', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('probe_id', self.gf('django.db.models.fields.IntegerField')()),
            ('unigene_title', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ('nucleotide_title', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
        ...
        db.send_create_signal('expressions', ['W303a_6mM_caffeine'])

        # Adding model 'W303a_1mM_caffeine'
        db.create_table('expressions_w303a_1mm_caffeine', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('probe_id', self.gf('django.db.models.fields.IntegerField')()),
            ('unigene_title', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ('nucleotide_title', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
        ...
        db.send_create_signal('expressions', ['W303a_1mM_caffeine'])

        # Adding model 'W303a_5ng_ml_rapamycin'
        db.create_table('expressions_w303a_5ng_ml_rapamycin', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('probe_id', self.gf('django.db.models.fields.IntegerField')()),
            ('unigene_title', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ('nucleotide_title', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
        ...
        db.send_create_signal('expressions', ['W303a_5ng_ml_rapamycin'])

        # Adding model 'W303a_9mM_caffeine'
        db.create_table('expressions_w303a_9mm_caffeine', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('probe_id', self.gf('django.db.models.fields.IntegerField')()),
            ('unigene_title', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ('nucleotide_title', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
        ...
        db.send_create_signal('expressions', ['W303a_9mM_caffeine'])

        # Adding model 'W303a_200ng_ml_rapamycin'
        db.create_table('expressions_w303a_200ng_ml_rapamycin', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('probe_id', self.gf('django.db.models.fields.IntegerField')()),
            ('unigene_title', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ('nucleotide_title', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
        ...
        db.send_create_signal('expressions', ['W303a_200ng_ml_rapamycin'])

        # Adding model 'Sigma2000_rapamycin'
        db.create_table('expressions_sigma2000_rapamycin', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('probe_id', self.gf('django.db.models.fields.IntegerField')()),
            ('unigene_title', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ('nucleotide_title', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
        ...
        db.send_create_signal('expressions', ['Sigma2000_rapamycin'])

        # Adding model 'W303a_1ng_ml_rapamycin'
        db.create_table('expressions_w303a_1ng_ml_rapamycin', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('probe_id', self.gf('django.db.models.fields.IntegerField')()),
            ('unigene_title', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ('nucleotide_title', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
        ...
        db.send_create_signal('expressions', ['W303a_1ng_ml_rapamycin'])

        # Adding model 'S288c_rapamycin'
        db.create_table('expressions_s288c_rapamycin', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('probe_id', self.gf('django.db.models.fields.IntegerField')()),
            ('unigene_title', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ('nucleotide_title', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
        ...
        db.send_create_signal('expressions', ['S288c_rapamycin'])

        # Adding model 'W303a_0p3mM_caffeine'
        db.create_table('expressions_w303a_0p3mm_caffeine', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('probe_id', self.gf('django.db.models.fields.IntegerField')()),
            ('unigene_title', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ('nucleotide_title', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
        ...
        db.send_create_signal('expressions', ['W303a_0p3mM_caffeine'])


    def backwards(self, orm):
        
        # Deleting model 'W303a_3mM_caffeine'
        db.delete_table('expressions_w303a_3mm_caffeine')

        # Deleting model 'S288c_caffeine'
        db.delete_table('expressions_s288c_caffeine')

        # Deleting model 'Sigma2000_caffeine'
        db.delete_table('expressions_sigma2000_caffeine')

        # Deleting model 'W303a_6mM_caffeine'
        db.delete_table('expressions_w303a_6mm_caffeine')

        # Deleting model 'W303a_1mM_caffeine'
        db.delete_table('expressions_w303a_1mm_caffeine')

        # Deleting model 'W303a_5ng_ml_rapamycin'
        db.delete_table('expressions_w303a_5ng_ml_rapamycin')

        # Deleting model 'W303a_9mM_caffeine'
        db.delete_table('expressions_w303a_9mm_caffeine')

        # Deleting model 'W303a_200ng_ml_rapamycin'
        db.delete_table('expressions_w303a_200ng_ml_rapamycin')

        # Deleting model 'Sigma2000_rapamycin'
        db.delete_table('expressions_sigma2000_rapamycin')

        # Deleting model 'W303a_1ng_ml_rapamycin'
        db.delete_table('expressions_w303a_1ng_ml_rapamycin')

        # Deleting model 'S288c_rapamycin'
        db.delete_table('expressions_s288c_rapamycin')

        # Deleting model 'W303a_0p3mM_caffeine'
        db.delete_table('expressions_w303a_0p3mm_caffeine')
