...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Replicate'
        db.create_table('expressions_replicate', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('probe_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('intensity', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('expressions', ['Replicate'])

        # Adding model 'Array'
        db.create_table('expressions_array', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('expressions', ['Array'])

        # Adding M2M table for field intensities on 'Array'
        db.create_table('expressions_array_intensities', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('array', models.ForeignKey(orm['expressions.array'], null=False)),
            ('replicate', models.ForeignKey(orm['expressions.replicate'], null=False))
        ))
        db.create_unique('expressions_array_intensities', ['array_id', 'replicate_id'])

        # Adding model 'Transcript'
        db.create_table('expressions_transcript', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('probe_id', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('profile', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['expressions.Profile'])),
            ('ratio', self.gf('django.db.models.fields.FloatField')()),
            ('pvalue', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('expressions', ['Transcript'])

        # Adding model 'Intensity'
        db.create_table('expressions_intensity', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('value', self.gf('django.db.models.fields.FloatField')()),
            ('probe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['expressions.Transcript'])),
        ))
        db.send_create_signal('expressions', ['Intensity'])

        # Adding model 'Signature'
        db.create_table('expressions_signature', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('expressions', ['Signature'])

        # Adding M2M table for field profiles on 'Signature'
        db.create_table('expressions_signature_profiles', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('signature', models.ForeignKey(orm['expressions.signature'], null=False)),
            ('profile', models.ForeignKey(orm['expressions.profile'], null=False))
        ))
        db.create_unique('expressions_signature_profiles', ['signature_id', 'profile_id'])

        # Adding M2M table for field transcripts on 'Signature'
        db.create_table('expressions_signature_transcripts', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('signature', models.ForeignKey(orm['expressions.signature'], null=False)),
            ('transcript', models.ForeignKey(orm['expressions.transcript'], null=False))
        ))
        db.create_unique('expressions_signature_transcripts', ['signature_id', 'transcript_id'])

        # Adding M2M table for field genes on 'Signature'
        db.create_table('expressions_signature_genes', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('signature', models.ForeignKey(orm['expressions.signature'], null=False)),
            ('gene', models.ForeignKey(orm['expressions.gene'], null=False))
        ))
        db.create_unique('expressions_signature_genes', ['signature_id', 'gene_id'])

        # Adding model 'Contrast'
        db.create_table('expressions_contrast', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ratio', self.gf('django.db.models.fields.FloatField')()),
            ('pvalue', self.gf('django.db.models.fields.FloatField')()),
        ))
        db.send_create_signal('expressions', ['Contrast'])

        # Adding M2M table for field exp on 'Contrast'
        db.create_table('expressions_contrast_exp', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('contrast', models.ForeignKey(orm['expressions.contrast'], null=False)),
            ('profile', models.ForeignKey(orm['expressions.profile'], null=False))
        ))
        db.create_unique('expressions_contrast_exp', ['contrast_id', 'profile_id'])

        # Adding M2M table for field ctr on 'Contrast'
        db.create_table('expressions_contrast_ctr', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('contrast', models.ForeignKey(orm['expressions.contrast'], null=False)),
            ('profile', models.ForeignKey(orm['expressions.profile'], null=False))
        ))
        db.create_unique('expressions_contrast_ctr', ['contrast_id', 'profile_id'])

        # Adding model 'Gene'
        db.create_table('expressions_gene', (
        ...
        db.send_create_signal('expressions', ['Gene'])

        # Adding model 'Profile'
        db.create_table('expressions_profile', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('species', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['annotations.Species'])),
            ('tissue', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['annotations.Tissue'])),
            ('diet', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lifespan.Manipulation'])),
        ))
        db.send_create_signal('expressions', ['Profile'])

        # Adding M2M table for field replicates on 'Profile'
        db.create_table('expressions_profile_replicates', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('profile', models.ForeignKey(orm['expressions.profile'], null=False)),
            ('replicate', models.ForeignKey(orm['expressions.replicate'], null=False))
        ))
        db.create_unique('expressions_profile_replicates', ['profile_id', 'replicate_id'])


    def backwards(self, orm):
        # Deleting model 'Replicate'
        db.delete_table('expressions_replicate')

        # Deleting model 'Array'
        db.delete_table('expressions_array')

        # Removing M2M table for field intensities on 'Array'
        db.delete_table('expressions_array_intensities')

        # Deleting model 'Transcript'
        db.delete_table('expressions_transcript')

        # Deleting model 'Intensity'
        db.delete_table('expressions_intensity')

        # Deleting model 'Signature'
        db.delete_table('expressions_signature')

        # Removing M2M table for field profiles on 'Signature'
        db.delete_table('expressions_signature_profiles')

        # Removing M2M table for field transcripts on 'Signature'
        db.delete_table('expressions_signature_transcripts')

        # Removing M2M table for field genes on 'Signature'
        db.delete_table('expressions_signature_genes')

        # Deleting model 'Contrast'
        db.delete_table('expressions_contrast')

        # Removing M2M table for field exp on 'Contrast'
        db.delete_table('expressions_contrast_exp')

        # Removing M2M table for field ctr on 'Contrast'
        db.delete_table('expressions_contrast_ctr')

        # Deleting model 'Gene'
        db.delete_table('expressions_gene')

        # Deleting model 'Profile'
        db.delete_table('expressions_profile')

        # Removing M2M table for field replicates on 'Profile'
        db.delete_table('expressions_profile_replicates')
    ...
    models = {
        ...
        'expressions.profile': {
            ...
            'diet': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['lifespan.Manipulation']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'replicates': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['expressions.Replicate']", 'symmetrical': 'False'}),
            'species': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['annotations.Species']"}),
            'tissue': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['annotations.Tissue']"})
        },
        ...
        'expressions.signature': {
            ...
            'genes': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['expressions.Gene']", 'symmetrical': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'profiles': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['expressions.Profile']", 'symmetrical': 'False'}),
            'transcripts': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['expressions.Transcript']", 'symmetrical': 'False'})
        },
        ...
        'expressions.transcript': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'probe_id': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'profile': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['expressions.Profile']"}),
            'pvalue': ('django.db.models.fields.FloatField', [], {}),
            'ratio': ('django.db.models.fields.FloatField', [], {})
        },
