...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Set'
        db.create_table('expressions_set', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('expressions', ['Set'])

        # Adding M2M table for field signatures on 'Set'
        db.create_table('expressions_set_signatures', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('set', models.ForeignKey(orm['expressions.set'], null=False)),
            ('signature', models.ForeignKey(orm['expressions.signature'], null=False))
        ))
        db.create_unique('expressions_set_signatures', ['set_id', 'signature_id'])


        # Changing field 'Transcript.effect_size'
        db.alter_column('expressions_transcript', 'effect_size', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Transcript.pvalue'
        db.alter_column('expressions_transcript', 'pvalue', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Expression.effect_size'
        db.alter_column('expressions_expression', 'effect_size', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'Expression.pvalue'
        db.alter_column('expressions_expression', 'pvalue', self.gf('django.db.models.fields.FloatField')(null=True))

    def backwards(self, orm):
        # Deleting model 'Set'
        db.delete_table('expressions_set')

        # Removing M2M table for field signatures on 'Set'
        db.delete_table('expressions_set_signatures')


        # Changing field 'Transcript.effect_size'
        db.alter_column('expressions_transcript', 'effect_size', self.gf('django.db.models.fields.FloatField')(default=None))

        # Changing field 'Transcript.pvalue'
        db.alter_column('expressions_transcript', 'pvalue', self.gf('django.db.models.fields.FloatField')(default=None))

        # Changing field 'Expression.effect_size'
        db.alter_column('expressions_expression', 'effect_size', self.gf('django.db.models.fields.FloatField')(default=None))

        # Changing field 'Expression.pvalue'
        db.alter_column('expressions_expression', 'pvalue', self.gf('django.db.models.fields.FloatField')(default=None))
    ...
    models = {
        ...
        'expressions.expression': {
            ...
            'effect_size': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
        ...
        'expressions.set': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'signatures': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['expressions.Signature']", 'symmetrical': 'False'})
        },
