...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field tissues on 'Signature'
        db.create_table('expressions_signature_tissues', (
        ...
        db.create_unique('expressions_signature_tissues', ['signature_id', 'tissue_id'])


    def backwards(self, orm):
        # Removing M2M table for field tissues on 'Signature'
        db.delete_table('expressions_signature_tissues')
