...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Transcript.profile'
        db.alter_column('expressions_transcript', 'profile_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['expressions.Profile'], null=True))

    def backwards(self, orm):

        # Changing field 'Transcript.profile'
        db.alter_column('expressions_transcript', 'profile_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['expressions.Profile']))
