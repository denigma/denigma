...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Replicate.profile_id'
        db.delete_column('expressions_replicate', 'profile_id_id')

        # Adding field 'Replicate.profile'
        db.add_column('expressions_replicate', 'profile',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['expressions.Profile']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Replicate.profile_id'
        db.add_column('expressions_replicate', 'profile_id',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['expressions.Profile']),
                      keep_default=False)

        # Deleting field 'Replicate.profile'
        db.delete_column('expressions_replicate', 'profile_id')
