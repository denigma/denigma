...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('expressions_expression', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('signature', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['expressions.Signature'])),
            ('transcript', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['expressions.Transcript'])),
        ...
        db.send_create_signal('expressions', ['Expression'])

        # Deleting field 'Transcript.probe_id'
        db.delete_column('expressions_transcript', 'probe_id')

        # Adding field 'Transcript.seq_id'
        db.add_column('expressions_transcript', 'seq_id',
    ...
    def backwards(self, orm):
        ...
        db.delete_table('expressions_expression')

        # Adding field 'Transcript.probe_id'
        db.add_column('expressions_transcript', 'probe_id',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255),
                      keep_default=False)

        # Deleting field 'Transcript.seq_id'
        db.delete_column('expressions_transcript', 'seq_id')
