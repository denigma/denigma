...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transcript.effect_size'
        db.add_column('expressions_transcript', 'effect_size',
                      self.gf('django.db.models.fields.FloatField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transcript.effect_size'
        db.delete_column('expressions_transcript', 'effect_size')
