...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transcript.benjamini'
        db.add_column('expressions_transcript', 'benjamini',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transcript.benjamini'
        db.delete_column('expressions_transcript', 'benjamini')
