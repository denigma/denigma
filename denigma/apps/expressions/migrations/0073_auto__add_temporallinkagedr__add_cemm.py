...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TemporalLinkageDR'
        db.create_table('expressions_temporallinkagedr', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('genbank', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('symbol', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('cr2', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('cr4', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('cr8', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('lt_cr', self.gf('django.db.models.fields.FloatField')()),
            ('con8', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('gene_class', self.gf('django.db.models.fields.CharField')(max_length=11)),
            ('category', self.gf('django.db.models.fields.CharField')(max_length=40)),
        ))
        db.send_create_signal('expressions', ['TemporalLinkageDR'])

        # Adding model 'CeMM'
        db.create_table('expressions_cemm', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ensembl', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('array_1', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('array_2', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('array_3', self.gf('django.db.models.fields.FloatField')(blank=True)),
        ))
        db.send_create_signal('expressions', ['CeMM'])


    def backwards(self, orm):
        
        # Deleting model 'TemporalLinkageDR'
        db.delete_table('expressions_temporallinkagedr')

        # Deleting model 'CeMM'
        db.delete_table('expressions_cemm')
