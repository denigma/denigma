...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Profile.tissue'
        db.delete_column('expressions_profile', 'tissue_id')

        # Adding M2M table for field tissue on 'Profile'
        db.create_table('expressions_profile_tissue', (
        ...
        db.create_unique('expressions_profile_tissue', ['profile_id', 'tissue_id'])


    def backwards(self, orm):
        # Adding field 'Profile.tissue'
        db.add_column('expressions_profile', 'tissue',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['annotations.Tissue']),
                      keep_default=False)

        # Removing M2M table for field tissue on 'Profile'
        db.delete_table('expressions_profile_tissue')
    ...
    models = {
        ...
        'expressions.signature': {
            ...
            'transcripts': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': "orm['expressions.Transcript']", 'null': 'True', 'blank': 'True'})
        },
