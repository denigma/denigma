...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Signature.species'
        db.add_column('expressions_signature', 'species',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=7227, to=orm['annotations.Species']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Signature.species'
        db.delete_column('expressions_signature', 'species_id')
