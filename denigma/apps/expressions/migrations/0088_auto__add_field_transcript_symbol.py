...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transcript.symbol'
        db.add_column('expressions_transcript', 'symbol',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Transcript.symbol'
        db.delete_column('expressions_transcript', 'symbol')
