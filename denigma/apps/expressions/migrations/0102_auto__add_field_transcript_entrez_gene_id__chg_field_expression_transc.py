...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Transcript.entrez_gene_id'
        db.add_column('expressions_transcript', 'entrez_gene_id',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Expression.transcript'
        db.alter_column('expressions_expression', 'transcript_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['expressions.Transcript'], null=True))

    def backwards(self, orm):
        # Deleting field 'Transcript.entrez_gene_id'
        db.delete_column('expressions_transcript', 'entrez_gene_id')


        # Changing field 'Expression.transcript'
        db.alter_column('expressions_expression', 'transcript_id', self.gf('django.db.models.fields.related.ForeignKey')(default='', to=orm['expressions.Transcript']))
    ...
    models = {
        ...
        'expressions.expression': {
            ...
            'benjamini': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'transcript': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['expressions.Transcript']", 'null': 'True', 'blank': 'True'})
        },
