...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Intervention.sex'
        db.add_column('datasets_intervention', 'sex', self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True), keep_default=False)

        # Adding field 'Intervention.lifespans'
        db.add_column('datasets_intervention', 'lifespans', self.gf('django.db.models.fields.CharField')(default='', max_length=25, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Intervention.sex'
        db.delete_column('datasets_intervention', 'sex')

        # Deleting field 'Intervention.lifespans'
        db.delete_column('datasets_intervention', 'lifespans')
