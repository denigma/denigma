...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reference.access_date'
        db.alter_column('datasets_reference', 'access_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Reference.epub_date'
        db.alter_column('datasets_reference', 'epub_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Reference.date'
        db.alter_column('datasets_reference', 'date', self.gf('django.db.models.fields.DateField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Reference.access_date'
        db.alter_column('datasets_reference', 'access_date', self.gf('django.db.models.fields.DateField')(default=None))

        # Changing field 'Reference.epub_date'
        db.alter_column('datasets_reference', 'epub_date', self.gf('django.db.models.fields.DateField')(default=None))

        # Changing field 'Reference.date'
        db.alter_column('datasets_reference', 'date', self.gf('django.db.models.fields.DateField')(default=None))
