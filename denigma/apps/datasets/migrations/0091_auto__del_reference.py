...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field references on 'Change'
        db.delete_table('datasets_change_references')
    ...
    def backwards(self, orm):
        ...
        db.create_table('datasets_reference', (
            ('name_of_database', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('author_address', self.gf('django.db.models.fields.CharField')(max_length=150, blank=True)),
            ('article_number', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('reprint_editione', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('journal', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
            ('year', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('translated_author', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('reviewed_itemse', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('keywords', self.gf('django.db.models.fields.CharField')(max_length=250, blank=True)),
            ('doi', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ...
            ('type_of_article', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pmcid', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('database_provider', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('volume', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('call_number', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('epub_date', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('nihmsid', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('language', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('research_notes', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('legal_note', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('notes', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('issn', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('accession_number', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('short_title', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('alternate_journal', self.gf('django.db.models.fields.CharField')(max_length=150, blank=True)),
            ...
            ('original_publication', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True)),
            ('pmid', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('issue', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75, blank=True)),
        ))
        db.send_create_signal('datasets', ['Reference'])

        # Adding M2M table for field references on 'Change'
        db.create_table('datasets_change_references', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('change', models.ForeignKey(orm['datasets.change'], null=False)),
            ('reference', models.ForeignKey(orm['datasets.reference'], null=False))
        ))
        db.create_unique('datasets_change_references', ['change_id', 'reference_id'])
