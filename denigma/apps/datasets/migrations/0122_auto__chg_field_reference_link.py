...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reference.link'
        db.alter_column('datasets_reference', 'link', self.gf('django.db.models.fields.URLField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'Reference.link'
        db.alter_column('datasets_reference', 'link', self.gf('django.db.models.fields.URLField')(default='', max_length=200))
