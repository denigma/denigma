...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ManipulationType'
        db.create_table(u'manipulation_type', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('from_manipulation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='from_manipulation', to=orm['datasets.Manipulation'])),
            ('to_manipulation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='to_manipulation', to=orm['datasets.Manipulation'])),
        ))
        db.send_create_signal('datasets', ['ManipulationType'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ManipulationType'
        db.delete_table(u'manipulation_type')
    ...
    models = {
        ...
        'datasets.manipulation': {
            ...
            'type': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'type_of'", 'blank': 'True', 'through': "orm['datasets.ManipulationType']", 'to': "orm['datasets.Manipulation']"})
        },
        'datasets.manipulationtype': {
            'Meta': {'object_name': 'ManipulationType', 'db_table': "u'manipulation_type'"},
            'from_manipulation': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'from_manipulation'", 'to': "orm['datasets.Manipulation']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'to_manipulation': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'to_manipulation'", 'to': "orm['datasets.Manipulation']"})
        },
