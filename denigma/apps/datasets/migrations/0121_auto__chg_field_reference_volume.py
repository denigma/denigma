...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'reference', 'volume', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))

    def backwards(self, orm):

        # Changing field 'Reference.volume'
        db.alter_column(u'reference', 'volume', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
