...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Gendr.function'
        db.alter_column('datasets_gendr', 'function', self.gf('django.db.models.fields.CharField')(max_length=500))


    def backwards(self, orm):
        
        # Changing field 'Gendr.function'
        db.alter_column('datasets_gendr', 'function', self.gf('django.db.models.fields.CharField')(max_length=250))
