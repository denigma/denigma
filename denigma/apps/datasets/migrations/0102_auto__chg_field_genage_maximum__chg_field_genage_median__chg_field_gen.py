...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('datasets_genage', 'maximum', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'GenAge.median'
        db.alter_column('datasets_genage', 'median', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'GenAge.mean'
        db.alter_column('datasets_genage', 'mean', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))
