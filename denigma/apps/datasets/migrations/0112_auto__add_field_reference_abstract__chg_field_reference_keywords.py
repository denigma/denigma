...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'reference', 'abstract',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'Reference.keywords'
        db.alter_column(u'reference', 'keywords', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):
        # Deleting field 'Reference.abstract'
        db.delete_column(u'reference', 'abstract')


        # Changing field 'Reference.keywords'
        db.alter_column(u'reference', 'keywords', self.gf('django.db.models.fields.CharField')(max_length=250))
