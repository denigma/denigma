...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Intervention.taxid'
        db.add_column('datasets_intervention', 'taxid', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Intervention.taxid'
        db.delete_column('datasets_intervention', 'taxid')
