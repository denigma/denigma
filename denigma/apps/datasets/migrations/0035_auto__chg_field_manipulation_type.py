...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Manipulation.type'
        db.alter_column('datasets_manipulation', 'type', self.gf('django.db.models.fields.CharField')(max_length=250, null=True))


    def backwards(self, orm):
        
        # Changing field 'Manipulation.type'
        db.alter_column('datasets_manipulation', 'type', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
    ...
    models = {
        ...
        'datasets.manipulation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '250', 'null': 'True', 'blank': 'True'})
        },
