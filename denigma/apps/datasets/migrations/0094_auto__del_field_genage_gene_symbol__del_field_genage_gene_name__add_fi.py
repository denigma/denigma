...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Rename field 'GenAge.gene_symbol' to 'GenAge.symbol
        db.rename_column('datasets_genage', 'gene_symbol', 'symbol')

        # Rename field 'GenAge.gene_name' to 'GenAge.name'
        db.rename_column('datasets_genage', 'gene_name', 'name')
        
    def backwards(self, orm):
        
        # Rename field 'GenAge.symbol' to 'GenAge.gene_symbol'
        db.rename_column('datasets_genage', 'symbol', 'gene_symbol')

        # Rename field 'GenAge.name' to 'GenAge.gene_name'
        db.rename_column('datasets_genage', 'name', 'gene_name')
    ...
    models = {
        ...
        'datasets.genage': {
            ...
            'symbol': ('django.db.models.fields.CharField', [], {'max_length': '13'}),
