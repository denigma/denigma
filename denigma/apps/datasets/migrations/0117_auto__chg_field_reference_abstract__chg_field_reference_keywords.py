...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reference.abstract'
        db.alter_column(u'reference', 'abstract', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'Reference.keywords'
        db.alter_column(u'reference', 'keywords', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Reference.abstract'
        db.alter_column(u'reference', 'abstract', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'Reference.keywords'
        db.alter_column(u'reference', 'keywords', self.gf('django.db.models.fields.TextField')(default=''))
