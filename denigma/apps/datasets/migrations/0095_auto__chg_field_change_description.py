...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Change.description'
        db.alter_column('datasets_change', 'description', self.gf('django.db.models.fields.TextField')(max_length=250))


    def backwards(self, orm):
        
        # Changing field 'Change.description'
        db.alter_column('datasets_change', 'description', self.gf('django.db.models.fields.TextField')())
