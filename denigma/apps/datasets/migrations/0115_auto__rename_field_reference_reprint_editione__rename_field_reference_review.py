...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Reference.reprint_editione' to 'Reference.reprint_edition'
        db.rename_column(u'reference', 'reprint_editione', 'reprint_edition')

        # Deleting field 'Reference.reviewed_itemse' to 'Reference.reviewed_items'
        db.rename_column(u'reference', 'reviewed_itemse', 'reviewed_items')

    def backwards(self, orm):
        # Renaming field 'Reference.reprint_edition' to 'Reference.reprint_editione'
        db.rename_column(u'reference', 'reprint_edition', 'reprint_editione')

        # Renaming field 'Reference.reviewed_items' to 'Reference.reviewed_items'
        db.rename_column(u'reference', 'reviewed_items', 'reviewed_itemse')
