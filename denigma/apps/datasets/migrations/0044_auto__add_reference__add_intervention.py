...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('datasets_intervention', (
            ...
            ('reference', self.gf('django.db.models.fields.IntegerField')(blank=True)),
        ))
        db.send_create_signal('datasets', ['Intervention'])

        # Adding M2M table for field taxid on 'Intervention'
        db.create_table('datasets_intervention_taxid', (
        ...
        db.create_unique('datasets_intervention_taxid', ['intervention_id', 'reference_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field taxid on 'Intervention'
        db.delete_table('datasets_intervention_taxid')
    ...
    models = {
        ...
        'datasets.intervention': {
            ...
            'mean': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'median': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'reference': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'taxid': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['datasets.Reference']", 'symmetrical': 'False'})
        },
