...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reference.issn'
        db.alter_column('datasets_reference', 'issn', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Reference.article_number'
        db.alter_column('datasets_reference', 'article_number', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Reference.call_number'
        db.alter_column('datasets_reference', 'call_number', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Reference.issue'
        db.alter_column('datasets_reference', 'issue', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Reference.volume'
        db.alter_column('datasets_reference', 'volume', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Reference.pmid'
        db.alter_column('datasets_reference', 'pmid', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Reference.pmcid'
        db.alter_column('datasets_reference', 'pmcid', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Reference.nihmsid'
        db.alter_column('datasets_reference', 'nihmsid', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Reference.accession_number'
        db.alter_column('datasets_reference', 'accession_number', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Reference.issn'
        db.alter_column('datasets_reference', 'issn', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'Reference.article_number'
        db.alter_column('datasets_reference', 'article_number', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'Reference.call_number'
        db.alter_column('datasets_reference', 'call_number', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'Reference.issue'
        db.alter_column('datasets_reference', 'issue', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'Reference.volume'
        db.alter_column('datasets_reference', 'volume', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'Reference.pmid'
        db.alter_column('datasets_reference', 'pmid', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'Reference.pmcid'
        db.alter_column('datasets_reference', 'pmcid', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'Reference.nihmsid'
        db.alter_column('datasets_reference', 'nihmsid', self.gf('django.db.models.fields.IntegerField')(default=None))

        # Changing field 'Reference.accession_number'
        db.alter_column('datasets_reference', 'accession_number', self.gf('django.db.models.fields.IntegerField')(default=None))
    ...
    models = {
        ...
        'datasets.genage': {
            ...
            'regimen': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['datasets.Regimen']", 'symmetrical': 'False', 'blank': 'True'}),
