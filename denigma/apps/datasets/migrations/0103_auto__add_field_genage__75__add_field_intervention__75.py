...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GenAge._75'
        db.add_column('datasets_genage', '_75', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True), keep_default=False)

        # Adding field 'Intervention._75'
        db.add_column('datasets_intervention', '_75', self.gf('django.db.models.fields.CharField')(max_length=15, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GenAge._75'
        db.delete_column('datasets_genage', '_75')

        # Deleting field 'Intervention._75'
        db.delete_column('datasets_intervention', '_75')
