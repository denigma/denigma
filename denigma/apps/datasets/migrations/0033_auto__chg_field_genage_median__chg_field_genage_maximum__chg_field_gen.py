...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('datasets_genage', 'median', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'GenAge.maximum'
        db.alter_column('datasets_genage', 'maximum', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'GenAge.mean'
        db.alter_column('datasets_genage', 'mean', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
