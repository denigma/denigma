...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('datasets_reference_categories', (
        ...
        db.create_unique('datasets_reference_categories', ['reference_id', 'entry_id'])


    def backwards(self, orm):
        # Removing M2M table for field categories on 'Reference'
        db.delete_table('datasets_reference_categories')
