...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        #db.alter_column('datasets_reference', 'id', self.gf('django.db.models.fields.AutoField')(primary_key=True))


    def backwards(self, orm):
        pass
        # Changing field 'Reference.id'
        #db.alter_column('datasets_reference', 'id', self.gf('django.db.models.fields.IntegerField')(primary_key=True))
