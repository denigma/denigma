...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'reference', 'issue', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

    def backwards(self, orm):

        # Changing field 'Reference.issue'
        db.alter_column(u'reference', 'issue', self.gf('django.db.models.fields.CharField')(default='', max_length=10))
