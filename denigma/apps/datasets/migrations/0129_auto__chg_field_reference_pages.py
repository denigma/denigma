...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('datasets_reference', 'pages', self.gf('django.db.models.fields.CharField')(max_length=23))

    def backwards(self, orm):

        # Changing field 'Reference.pages'
        db.alter_column('datasets_reference', 'pages', self.gf('django.db.models.fields.CharField')(max_length=10))
