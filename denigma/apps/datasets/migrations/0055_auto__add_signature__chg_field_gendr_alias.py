...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('datasets_signature', (
            ...
            ('exp', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('ctr', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ...
            ('experimental', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('control', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('tissue', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('age', self.gf('django.db.models.fields.CharField')(max_length=30, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
        ))
        db.send_create_signal('datasets', ['Signature'])

        # Changing field 'Gendr.alias'
        db.alter_column('datasets_gendr', 'alias', self.gf('django.db.models.fields.CharField')(max_length=50))


    def backwards(self, orm):
        
        # Deleting model 'Signature'
        db.delete_table('datasets_signature')

        # Changing field 'Gendr.alias'
        db.alter_column('datasets_gendr', 'alias', self.gf('django.db.models.fields.CharField')(max_length=13))
