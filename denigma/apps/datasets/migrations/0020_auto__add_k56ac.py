...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'K56Ac'
        db.create_table('datasets_k56ac', (
            ('ensembl_gene', self.gf('django.db.models.fields.CharField')(max_length=9, primary_key=True)),
            ('level', self.gf('django.db.models.fields.FloatField')()),
            ('expression', self.gf('django.db.models.fields.FloatField')()),
        ...
        db.send_create_signal('datasets', ['K56Ac'])


    def backwards(self, orm):
        
        # Deleting model 'K56Ac'
        db.delete_table('datasets_k56ac')
