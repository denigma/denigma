...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GenAge.median'
        db.alter_column('datasets_genage', 'median', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'GenAge.maximum'
        db.alter_column('datasets_genage', 'maximum', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'GenAge.mean'
        db.alter_column('datasets_genage', 'mean', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'GenAge.median'
        db.alter_column('datasets_genage', 'median', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'GenAge.maximum'
        db.alter_column('datasets_genage', 'maximum', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'GenAge.mean'
        db.alter_column('datasets_genage', 'mean', self.gf('django.db.models.fields.FloatField')(null=True))
    ...
    models = {
        ...
        'datasets.genage': {
            ...
            'mean': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'median': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
