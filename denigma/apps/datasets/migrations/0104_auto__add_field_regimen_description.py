...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Regimen.description'
        db.add_column('datasets_regimen', 'description', self.gf('django.db.models.fields.TextField')(default=None), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Regimen.description'
        db.delete_column('datasets_regimen', 'description')
