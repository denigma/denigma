...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Gendr.classification'
        db.alter_column('datasets_gendr', 'classification', self.gf('django.db.models.fields.CharField')(max_length=10))


    def backwards(self, orm):
        
        # Changing field 'Gendr.classification'
        db.alter_column('datasets_gendr', 'classification', self.gf('django.db.models.fields.CharField')(max_length=5))
