...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'reference', 'doi', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Reference.doi'
        db.alter_column(u'reference', 'doi', self.gf('django.db.models.fields.CharField')(max_length=30))
