...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DR_Essential'
        db.create_table('datasets_dr_essential', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('taxid', self.gf('django.db.models.fields.IntegerField')()),
            ('classification', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('entrez_gene_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('gene_symbol', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal('datasets', ['DR_Essential'])


    def backwards(self, orm):
        
        # Deleting model 'DR_Essential'
        db.delete_table('datasets_dr_essential')
