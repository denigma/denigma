...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field lifespan on 'Gendr'
        db.create_table('datasets_gendr_lifespan', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('gendr', models.ForeignKey(orm['datasets.gendr'], null=False)),
            ('lifespan', models.ForeignKey(orm['datasets.lifespan'], null=False))
        ))
        db.create_unique('datasets_gendr_lifespan', ['gendr_id', 'lifespan_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field lifespan on 'Gendr'
        db.delete_table('datasets_gendr_lifespan')
