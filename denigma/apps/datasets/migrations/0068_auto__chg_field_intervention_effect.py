...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Intervention.effect'
        db.alter_column('datasets_intervention', 'effect', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'Intervention.effect'
        db.alter_column('datasets_intervention', 'effect', self.gf('django.db.models.fields.CharField')(max_length=250))
