...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('datasets_manipulation', (
        ...
        db.create_table('datasets_intervention', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('effect', self.gf('django.db.models.fields.CharField')(max_length=250)),
    ...
    def backwards(self, orm):
        ...
        db.delete_table('datasets_manipulation')
    ...
    models = {
        ...
        'datasets.intervention': {
            ...
            'effect': ('django.db.models.fields.CharField', [], {'max_length': '250'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'manipulation': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['datasets.Manipulation']", 'symmetrical': 'False'}),
            'maximum': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'mean': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'median': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'})
        },
