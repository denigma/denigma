...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Pokholok'
        db.create_table('datasets_pokholok', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ensembl_gene', self.gf('django.db.models.fields.CharField')(max_length=19)),
            ('chr', self.gf('django.db.models.fields.IntegerField')()),
            ('pos', self.gf('django.db.models.fields.IntegerField')()),
            ('h3_ypd', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('h4_ypd', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('h3_h2o2', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('h3k9acvsh3_ypd', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('h3k14acvsh3_ypd', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('h3k14acvswce_ypd', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('h314acvsh3_h2o2', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('h4acvsh3_ypd', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('h4acvsh3_h2o2', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('h3k4me1vsh3_ypd', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('h3k4me2vsh3_ypd', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('h3k4me3vsh3_ypd', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('h3k36me3vsh3_ypd', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('h3k79me3vsh3_ypd', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('esa1_ypd', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('gcn5_ypd', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('gcn4_aa', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('gg_ypd', self.gf('django.db.models.fields.FloatField')(blank=True)),
            ('noab_ypd', self.gf('django.db.models.fields.FloatField')(blank=True)),
        ...
        db.send_create_signal('datasets', ['Pokholok'])


    def backwards(self, orm):
        
        # Deleting model 'Pokholok'
        db.delete_table('datasets_pokholok')
    ...
    models = {
        ...
        'datasets.pokholok': {
            ...
            'h314acvsh3_h2o2': ('django.db.models.fields.FloatField', [], {'blank': 'True'}),
