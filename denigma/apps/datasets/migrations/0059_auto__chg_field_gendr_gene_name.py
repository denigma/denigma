...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('datasets_gendr', 'gene_name', self.gf('django.db.models.fields.CharField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'Gendr.gene_name'
        db.alter_column('datasets_gendr', 'gene_name', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        'datasets.gendr': {
            ...
            'gene_name': ('django.db.models.fields.CharField', [], {'max_length': '100', 'blank': 'True'}),
            'gene_symbol': ('django.db.models.fields.CharField', [], {'max_length': '13', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
