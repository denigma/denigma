...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'reference', 'title', self.gf('django.db.models.fields.CharField')(max_length=400))

    def backwards(self, orm):

        # Changing field 'Reference.title'
        db.alter_column(u'reference', 'title', self.gf('django.db.models.fields.CharField')(max_length=250))
