...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Intervention.pmid'
        db.add_column('datasets_intervention', 'pmid', self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Intervention.pmid'
        db.delete_column('datasets_intervention', 'pmid')
