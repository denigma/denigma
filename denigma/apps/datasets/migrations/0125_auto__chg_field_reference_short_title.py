...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reference.short_title'
        db.alter_column('datasets_reference', 'short_title', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

    def backwards(self, orm):

        # Changing field 'Reference.short_title'
        db.alter_column('datasets_reference', 'short_title', self.gf('django.db.models.fields.CharField')(default='', max_length=50))
