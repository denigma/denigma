...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field regimen on 'Gendr'
        db.create_table('datasets_gendr_regimen', (
        ...
        db.create_unique('datasets_gendr_regimen', ['gendr_id', 'regimen_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field regimen on 'Gendr'
        db.delete_table('datasets_gendr_regimen')
