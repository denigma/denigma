...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        pass
        # Removing unique constraint on 'Reference', fields ['pmid']
        #db.delete_unique('datasets_reference', ['pmid'])

        # Changing field 'Reference.id'
        #db.alter_column('datasets_reference', 'id', self.gf('django.db.models.fields.IntegerField')(default=None, primary_key=True))

        # Adding unique constraint on 'Reference', fields ['id']
        #db.create_unique('datasets_reference', ['id'])
    ...
    def backwards(self, orm):
        pass
        # Removing unique constraint on 'Reference', fields ['id']
        #db.delete_unique('datasets_reference', ['id'])

        # Changing field 'Reference.id'
        #db.alter_column('datasets_reference', 'id', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Reference.pmid'
        #db.alter_column('datasets_reference', 'pmid', self.gf('django.db.models.fields.IntegerField')(default=None, primary_key=True))

        # Adding unique constraint on 'Reference', fields ['pmid']
        #db.create_unique('datasets_reference', ['pmid'])
