...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reference.start_page'
        db.alter_column('datasets_reference', 'start_page', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Reference.start_page'
        db.alter_column('datasets_reference', 'start_page', self.gf('django.db.models.fields.IntegerField')(default=None))
