...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Reference.alternate_journal'
        db.alter_column('datasets_reference', 'alternate_journal', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'Reference.alternate_journal'
        db.alter_column('datasets_reference', 'alternate_journal', self.gf('django.db.models.fields.CharField')(default='', max_length=150))
