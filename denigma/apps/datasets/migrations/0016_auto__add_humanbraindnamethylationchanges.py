...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'HumanBrainDnaMethylationChanges'
        db.create_table('datasets_humanbraindnamethylationchanges', (
            ...
            ('chr', self.gf('django.db.models.fields.IntegerField')()),
            ('genomic_position_in_bp', self.gf('django.db.models.fields.IntegerField')()),
            ('gene_symbol', self.gf('django.db.models.fields.CharField')(max_length=7)),
            ('distance_to_tss', self.gf('django.db.models.fields.IntegerField')()),
            ('stage_i_pvalue_crblm', self.gf('django.db.models.fields.FloatField')()),
            ('stage_i_pvalue_fctx', self.gf('django.db.models.fields.FloatField')()),
            ('stage_i_pvalue_pons', self.gf('django.db.models.fields.FloatField')()),
            ('stage_i_pvalue_tctx', self.gf('django.db.models.fields.FloatField')()),
            ('stage_ii_pvalue_crblm', self.gf('django.db.models.fields.FloatField')()),
            ('stage_ii_pvalue_fctx', self.gf('django.db.models.fields.FloatField')()),
            ('beta_coefficient_range', self.gf('django.db.models.fields.CharField')(max_length=13)),
            ('adjusted_r2_estimates_from_stage_i_crblm', self.gf('django.db.models.fields.FloatField')()),
            ('adjusted_r2_estimates_from_stage_i_fctx', self.gf('django.db.models.fields.FloatField')()),
            ('adjusted_r2_estimates_from_stage_i_pons', self.gf('django.db.models.fields.FloatField')()),
            ('adjusted_r2_estimates_from_stage_i_tctx', self.gf('django.db.models.fields.FloatField')()),
            ('cpg_sequence', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('size', self.gf('django.db.models.fields.CharField')(max_length=4)),
            ('cpg_count', self.gf('django.db.models.fields.CharField')(max_length=4)),
            ('c_g_count', self.gf('django.db.models.fields.CharField')(max_length=4)),
            ('percentage_cpg', self.gf('django.db.models.fields.CharField')(max_length=4)),
            ('percentage_c_or_g', self.gf('django.db.models.fields.CharField')(max_length=4)),
            ('ratio', self.gf('django.db.models.fields.CharField')(max_length=4)),
            ('cpg_sequence_2kb', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal('datasets', ['HumanBrainDnaMethylationChanges'])


    def backwards(self, orm):
        
        # Deleting model 'HumanBrainDnaMethylationChanges'
        db.delete_table('datasets_humanbraindnamethylationchanges')
