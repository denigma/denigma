...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'GenCC'
        db.create_table('datasets_gencc', (
            ...
            ('alias', self.gf('django.db.models.fields.CharField')(max_length=68, blank=True)),
            ...
            ('observation', self.gf('django.db.models.fields.CharField')(max_length=248, blank=True)),
            ('pubmed_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('reference', self.gf('django.db.models.fields.CharField')(max_length=37, blank=True)),
            ('classification', self.gf('django.db.models.fields.CharField')(max_length=5)),
            ('peak_mrna', self.gf('django.db.models.fields.CharField')(max_length=5, blank=True)),
            ('peak_protein', self.gf('django.db.models.fields.CharField')(max_length=5, blank=True)),
            ('peak_actvity', self.gf('django.db.models.fields.CharField')(max_length=5, blank=True)),
        ))
        db.send_create_signal('datasets', ['GenCC'])


    def backwards(self, orm):
        
        # Deleting model 'GenCC'
        db.delete_table('datasets_gencc')
