...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Gendr.function'
        db.add_column('datasets_gendr', 'function', self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Gendr.function'
        db.delete_column('datasets_gendr', 'function')
