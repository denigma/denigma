...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Acetylation'
        db.create_table('datasets_acetylation', (
            ('ensembl_gene', self.gf('django.db.models.fields.CharField')(max_length=9, primary_key=True)),
            ('h4k8', self.gf('django.db.models.fields.FloatField')()),
            ('h4k12', self.gf('django.db.models.fields.FloatField')()),
            ('h4k16', self.gf('django.db.models.fields.FloatField')()),
            ('h3k9', self.gf('django.db.models.fields.FloatField')()),
            ('h3k14', self.gf('django.db.models.fields.FloatField')()),
            ('oh3k18', self.gf('django.db.models.fields.FloatField')()),
            ('h3k23', self.gf('django.db.models.fields.FloatField')()),
            ('h3k27', self.gf('django.db.models.fields.FloatField')()),
            ('h2ak7', self.gf('django.db.models.fields.FloatField')()),
            ('h2bk11', self.gf('django.db.models.fields.FloatField')()),
            ('h2bk16', self.gf('django.db.models.fields.FloatField')()),
        ...
        db.send_create_signal('datasets', ['Acetylation'])


    def backwards(self, orm):
        
        # Deleting model 'Acetylation'
        db.delete_table('datasets_acetylation')
    ...
    models = {
        'datasets.acetylation': {
            ...
            'oh3k18': ('django.db.models.fields.FloatField', [], {})
        },
