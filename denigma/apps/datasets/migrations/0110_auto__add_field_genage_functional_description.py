...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GenAge.functional_description'
        db.add_column('datasets_genage', 'functional_description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GenAge.functional_description'
        db.delete_column('datasets_genage', 'functional_description')
    ...
    models = {
        ...
        'datasets.genage': {
            ...
            'types': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['datasets.Type']", 'symmetrical': 'False', 'blank': 'True'})
        },
        'datasets.gencc': {
