...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GenAge.diet_regimen'
        db.add_column('datasets_genage', 'diet_regimen', self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True), keep_default=False)

        # Adding field 'GenAge.life_span'
        db.add_column('datasets_genage', 'life_span', self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True), keep_default=False)

        # Adding field 'GenAge.gene_intervention'
        db.add_column('datasets_genage', 'gene_intervention', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GenAge.diet_regimen'
        db.delete_column('datasets_genage', 'diet_regimen')

        # Deleting field 'GenAge.life_span'
        db.delete_column('datasets_genage', 'life_span')

        # Deleting field 'GenAge.gene_intervention'
        db.delete_column('datasets_genage', 'gene_intervention')
