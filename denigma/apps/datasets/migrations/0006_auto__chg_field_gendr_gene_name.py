...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Gendr.gene_name'
        db.alter_column('datasets_gendr', 'gene_name', self.gf('django.db.models.fields.CharField')(max_length=11))
    ...
    models = {
        ...
        'datasets.gendr': {
            ...
            'gene_name': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
