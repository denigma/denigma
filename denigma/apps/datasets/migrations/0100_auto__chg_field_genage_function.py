...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GenAge.function'
        db.alter_column('datasets_genage', 'function', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'GenAge.function'
        db.alter_column('datasets_genage', 'function', self.gf('django.db.models.fields.CharField')(max_length=500))
