...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NewLongevityRegulators'
        db.create_table('datasets_newlongevityregulators', (
            ...
            ('wormbase_id', self.gf('django.db.models.fields.CharField')(max_length=14)),
            ('phenotype', self.gf('django.db.models.fields.CharField')(max_length=11)),
            ('classification', self.gf('django.db.models.fields.CharField')(max_length=2)),
        ))
        db.send_create_signal('datasets', ['NewLongevityRegulators'])

        # Adding model 'SurvivingInTheCold'
        db.create_table('datasets_survivinginthecold', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entrez_gene_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('mapping', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('locus_tag', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('protein_accession_number', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('sgd_id', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('embl', self.gf('django.db.models.fields.CharField')(max_length=6)),
        ))
        db.send_create_signal('datasets', ['SurvivingInTheCold'])

        # Adding model 'JoanneGenes'
        db.create_table('datasets_joannegenes', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entrez_gene_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('mapping', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('gene_symbol', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('ensembl_gene_id', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('dn', self.gf('django.db.models.fields.FloatField')()),
            ('ds', self.gf('django.db.models.fields.FloatField')()),
            ('dn_ds', self.gf('django.db.models.fields.FloatField')()),
            ('human_percentage_id', self.gf('django.db.models.fields.IntegerField')()),
            ('chimp_percentage_id', self.gf('django.db.models.fields.IntegerField')()),
            ('chimp_ensembl_gene_id', self.gf('django.db.models.fields.CharField')(max_length=19)),
            ('assoc_gene_name', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('cds_length', self.gf('django.db.models.fields.IntegerField')()),
            ('longevity', self.gf('django.db.models.fields.CharField')(max_length=18)),
        ))
        db.send_create_signal('datasets', ['JoanneGenes'])

        # Adding model 'ClockModulator'
        db.create_table('datasets_clockmodulator', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entrez_gene_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('mapping', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('confirmed_by_bmal1_kockdown', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('gene_symbol', self.gf('django.db.models.fields.CharField')(max_length=9)),
            ('rna_nucleotide_accession_version', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('gene_name', self.gf('django.db.models.fields.CharField')(max_length=152)),
            ('phenotype', self.gf('django.db.models.fields.CharField')(max_length=30)),
            ('classification', self.gf('django.db.models.fields.CharField')(max_length=8)),
        ))
        db.send_create_signal('datasets', ['ClockModulator'])

        # Adding model 'NewLongevityRegulatorsCandidates'
        db.create_table('datasets_newlongevityregulatorscandidates', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entrez_gene_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('mapping', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('wormbase_id', self.gf('django.db.models.fields.CharField')(max_length=14, blank=True)),
            ('gene_symbol', self.gf('django.db.models.fields.CharField')(max_length=9, blank=True)),
            ('ensembl_gene_id', self.gf('django.db.models.fields.CharField')(max_length=11)),
        ))
        db.send_create_signal('datasets', ['NewLongevityRegulatorsCandidates'])

        # Adding model 'CircadianSystemicEntrainedFactors'
        db.create_table('datasets_circadiansystemicentrainedfactors', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entrez_gene_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('mapping', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ...
        db.send_create_signal('datasets', ['CircadianSystemicEntrainedFactors'])

        # Adding model 'HumanGenes'
        db.create_table('datasets_humangenes', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('mapping', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('hagrid', self.gf('django.db.models.fields.IntegerField')()),
            ('gene_symbol', self.gf('django.db.models.fields.CharField')(max_length=8)),
            ('gene_name', self.gf('django.db.models.fields.CharField')(max_length=131)),
            ('aliases', self.gf('django.db.models.fields.CharField')(max_length=68, blank=True)),
            ('epd_accession', self.gf('django.db.models.fields.CharField')(max_length=11, blank=True)),
            ('orf_accession', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('cds_accession', self.gf('django.db.models.fields.CharField')(max_length=12, blank=True)),
            ('selection_reason', self.gf('django.db.models.fields.CharField')(max_length=21)),
            ('band', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ('location_start', self.gf('django.db.models.fields.IntegerField')()),
            ('location_end', self.gf('django.db.models.fields.IntegerField')()),
            ('orientation', self.gf('django.db.models.fields.IntegerField')()),
            ('function', self.gf('django.db.models.fields.CharField')(max_length=94)),
            ('cellular_location', self.gf('django.db.models.fields.CharField')(max_length=40)),
            ('expression', self.gf('django.db.models.fields.CharField')(max_length=69)),
            ('observations', self.gf('django.db.models.fields.TextField')()),
            ('omim', self.gf('django.db.models.fields.IntegerField')()),
            ('hprd', self.gf('django.db.models.fields.IntegerField')()),
            ('unigene', self.gf('django.db.models.fields.IntegerField')()),
            ('entrez_gene_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('homologene', self.gf('django.db.models.fields.IntegerField')()),
            ('swiss_prot', self.gf('django.db.models.fields.CharField')(max_length=11, blank=True)),
            ('interactions', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('homologues', self.gf('django.db.models.fields.TextField')()),
            ('reference', self.gf('django.db.models.fields.TextField')()),
            ('pubmed_ids', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal('datasets', ['HumanGenes'])

        # Adding model 'MurineImprinted'
        db.create_table('datasets_murineimprinted', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('entrez_gene_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('mapping', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('gene_symbol', self.gf('django.db.models.fields.CharField')(max_length=9)),
            ('chromosome', self.gf('django.db.models.fields.IntegerField')()),
            ('chromosome_region', self.gf('django.db.models.fields.CharField')(max_length=7)),
            ('expressed_parental_allele', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('gene_name', self.gf('django.db.models.fields.CharField')(max_length=74)),
            ('classification', self.gf('django.db.models.fields.CharField')(max_length=5)),
        ))
        db.send_create_signal('datasets', ['MurineImprinted'])


    def backwards(self, orm):
        
        # Deleting model 'NewLongevityRegulators'
        db.delete_table('datasets_newlongevityregulators')

        # Deleting model 'SurvivingInTheCold'
        db.delete_table('datasets_survivinginthecold')

        # Deleting model 'JoanneGenes'
        db.delete_table('datasets_joannegenes')

        # Deleting model 'ClockModulator'
        db.delete_table('datasets_clockmodulator')

        # Deleting model 'NewLongevityRegulatorsCandidates'
        db.delete_table('datasets_newlongevityregulatorscandidates')

        # Deleting model 'CircadianSystemicEntrainedFactors'
        db.delete_table('datasets_circadiansystemicentrainedfactors')

        # Deleting model 'HumanGenes'
        db.delete_table('datasets_humangenes')

        # Deleting model 'MurineImprinted'
        db.delete_table('datasets_murineimprinted')
