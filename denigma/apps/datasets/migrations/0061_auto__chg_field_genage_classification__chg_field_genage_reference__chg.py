...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GenAge.classification'
        db.alter_column('datasets_genage', 'classification', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'GenAge.reference'
        db.alter_column('datasets_genage', 'reference', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'GenAge.alias'
        db.alter_column('datasets_genage', 'alias', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'GenAge.pubmed_id'
        db.alter_column('datasets_genage', 'pubmed_id', self.gf('django.db.models.fields.CharField')(max_length=250))


    def backwards(self, orm):
        
        # Changing field 'GenAge.classification'
        db.alter_column('datasets_genage', 'classification', self.gf('django.db.models.fields.CharField')(max_length=5))

        # Changing field 'GenAge.reference'
        db.alter_column('datasets_genage', 'reference', self.gf('django.db.models.fields.CharField')(max_length=42))

        # Changing field 'GenAge.alias'
        db.alter_column('datasets_genage', 'alias', self.gf('django.db.models.fields.CharField')(max_length=4))

        # Changing field 'GenAge.pubmed_id'
        db.alter_column('datasets_genage', 'pubmed_id', self.gf('django.db.models.fields.CharField')(max_length=19))
