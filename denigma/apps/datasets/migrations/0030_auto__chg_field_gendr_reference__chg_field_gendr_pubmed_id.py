...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Gendr.reference'
        db.alter_column('datasets_gendr', 'reference', self.gf('django.db.models.fields.CharField')(max_length=250))

        # Changing field 'Gendr.pubmed_id'
        db.alter_column('datasets_gendr', 'pubmed_id', self.gf('django.db.models.fields.CharField')(max_length=87))


    def backwards(self, orm):
        
        # Changing field 'Gendr.reference'
        db.alter_column('datasets_gendr', 'reference', self.gf('django.db.models.fields.CharField')(max_length=27))

        # Changing field 'Gendr.pubmed_id'
        db.alter_column('datasets_gendr', 'pubmed_id', self.gf('django.db.models.fields.CharField')(max_length=250))
