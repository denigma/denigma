...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Change'
        db.create_table('datasets_change', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=250)),
            ('taxid', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('reference', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('pmid', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('tissue', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('comparision', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('start', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
            ('stop', self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True)),
        ))
        db.send_create_signal('datasets', ['Change'])


    def backwards(self, orm):
        
        # Deleting model 'Change'
        db.delete_table('datasets_change')
