...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PI3K.entrez_gene_id'
        db.add_column('expressions_pi3k', 'entrez_gene_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PI3K.entrez_gene_id'
        db.delete_column('expressions_pi3k', 'entrez_gene_id')
