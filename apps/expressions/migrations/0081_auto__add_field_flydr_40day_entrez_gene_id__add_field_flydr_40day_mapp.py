...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FlyDR_40day.entrez_gene_id'
        db.add_column('expressions_flydr_40day', 'entrez_gene_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'FlyDR_40day.mapping'
        db.add_column('expressions_flydr_40day', 'mapping', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'FlyDR_10day.entrez_gene_id'
        db.add_column('expressions_flydr_10day', 'entrez_gene_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'FlyDR_10day.mapping'
        db.add_column('expressions_flydr_10day', 'mapping', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'FlyDR_40day.entrez_gene_id'
        db.delete_column('expressions_flydr_40day', 'entrez_gene_id')

        # Deleting field 'FlyDR_40day.mapping'
        db.delete_column('expressions_flydr_40day', 'mapping')

        # Deleting field 'FlyDR_10day.entrez_gene_id'
        db.delete_column('expressions_flydr_10day', 'entrez_gene_id')

        # Deleting field 'FlyDR_10day.mapping'
        db.delete_column('expressions_flydr_10day', 'mapping')
