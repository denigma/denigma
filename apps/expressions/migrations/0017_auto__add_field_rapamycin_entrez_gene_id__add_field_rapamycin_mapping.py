...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Rapamycin.entrez_gene_id'
        db.add_column('expressions_rapamycin', 'entrez_gene_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Rapamycin.mapping'
        db.add_column('expressions_rapamycin', 'mapping', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Rapamycin.entrez_gene_id'
        db.delete_column('expressions_rapamycin', 'entrez_gene_id')

        # Deleting field 'Rapamycin.mapping'
        db.delete_column('expressions_rapamycin', 'mapping')
