...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('expressions_snf4delta_wt', (
            ...
            ('fold_change', self.gf('django.db.models.fields.CharField')(max_length=48)),
        ...
        db.create_table('expressions_sip2delta_aging', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('orf', self.gf('django.db.models.fields.CharField')(max_length=13)),
            ('gene_symbol', self.gf('django.db.models.fields.CharField')(max_length=5, blank=True)),
            ('fold_change', self.gf('django.db.models.fields.CharField')(max_length=129)),
        ...
        db.create_table('expressions_snf4delta_aging', (
            ...
            ('fold_change', self.gf('django.db.models.fields.CharField')(max_length=97)),
        ...
        db.create_table('expressions_sip2delta_wt', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('orf', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('gene_symbol', self.gf('django.db.models.fields.CharField')(max_length=6, blank=True)),
            ('fold_change', self.gf('django.db.models.fields.CharField')(max_length=78)),
    ...
    models = {
        ...
        'expressions.sip2delta_aging': {
            ...
            'fold_change': ('django.db.models.fields.CharField', [], {'max_length': '129'}),
            ...
            'orf': ('django.db.models.fields.CharField', [], {'max_length': '13'}),
        ...
        'expressions.sip2delta_wt': {
            ...
            'fold_change': ('django.db.models.fields.CharField', [], {'max_length': '78'}),
        ...
        'expressions.snf4delta_aging': {
            ...
            'fold_change': ('django.db.models.fields.CharField', [], {'max_length': '97'}),
        ...
        'expressions.snf4delta_wt': {
            ...
            'fold_change': ('django.db.models.fields.CharField', [], {'max_length': '48'}),
            'gene_symbol': ('django.db.models.fields.CharField', [], {'max_length': '6', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'main_process': ('django.db.models.fields.CharField', [], {'max_length': '56'}),
