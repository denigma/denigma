...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Yeast_rapamycin_200ng_mL_1h'
        db.create_table('expressions_yeast_rapamycin_200ng_ml_1h', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('probe_id', self.gf('django.db.models.fields.CharField')(max_length=10)),
            ...
            ('go_function_id', self.gf('django.db.models.fields.CharField')(max_length=176, blank=True)),
        ...
        db.send_create_signal('expressions', ['Yeast_rapamycin_200ng_mL_1h'])

        # Adding model 'Yeast_rapamycin_30min'
        db.create_table('expressions_yeast_rapamycin_30min', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('probe_id', self.gf('django.db.models.fields.CharField')(max_length=12)),
            ('unigene_title', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ('nucleotide_title', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
            ('go_component', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('unigene_id', self.gf('django.db.models.fields.CharField')(max_length=1, blank=True)),
        ...
        db.send_create_signal('expressions', ['Yeast_rapamycin_30min'])


    def backwards(self, orm):
        
        # Deleting model 'Yeast_rapamycin_200ng_mL_1h'
        db.delete_table('expressions_yeast_rapamycin_200ng_ml_1h')

        # Deleting model 'Yeast_rapamycin_30min'
        db.delete_table('expressions_yeast_rapamycin_30min')
    ...
    models = {
        ...
        'expressions.yeast_rapamycin_200ng_ml_1h': {
            'Meta': {'object_name': 'Yeast_rapamycin_200ng_mL_1h'},
            'chromosome_annotation': ('django.db.models.fields.CharField', [], {'max_length': '58', 'blank': 'True'}),
            'chromosome_location': ('django.db.models.fields.CharField', [], {'max_length': '1', 'blank': 'True'}),
            'entrez_gene_id': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'fold_change': ('django.db.models.fields.FloatField', [], {}),
        ...
        'expressions.yeast_rapamycin_30min': {
            'Meta': {'object_name': 'Yeast_rapamycin_30min'},
            'chromosome_annotation': ('django.db.models.fields.CharField', [], {'max_length': '58', 'blank': 'True'}),
            'chromosome_location': ('django.db.models.fields.CharField', [], {'max_length': '1', 'blank': 'True'}),
            'entrez_gene_id': ('django.db.models.fields.IntegerField', [], {'blank': 'True'}),
            'fold_change': ('django.db.models.fields.FloatField', [], {}),
