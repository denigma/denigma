...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PI3K.symbol'
        db.delete_column('expressions_pi3k', 'symbol')

        # Deleting field 'PI3K.name'
        db.delete_column('expressions_pi3k', 'name')


    def backwards(self, orm):
        
        # Adding field 'PI3K.symbol'
        db.add_column('expressions_pi3k', 'symbol', self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True), keep_default=False)

        # Adding field 'PI3K.name'
        db.add_column('expressions_pi3k', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)
