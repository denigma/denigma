...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'rapamycine_protein'
        db.create_table('expressions_rapamycine_protein', (
        ...
        db.send_create_signal('expressions', ['rapamycine_protein'])


    def backwards(self, orm):
        
        # Deleting model 'rapamycine_protein'
        db.delete_table('expressions_rapamycine_protein')
    ...
    models = {
        ...
        'expressions.rapamycine_protein': {
            'Meta': {'object_name': 'rapamycine_protein'},
