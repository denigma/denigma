...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'YeastDR'
        db.create_table('expressions_yeastdr', (
            ...
            ('ensembl_gene', self.gf('django.db.models.fields.CharField')(max_length=9)),
        ...
        db.send_create_signal('expressions', ['YeastDR'])

        # Adding model 'WormDR'
        db.create_table('expressions_wormdr', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('probe_id', self.gf('django.db.models.fields.CharField')(max_length=25)),
            ('entrez_gene', self.gf('django.db.models.fields.CharField')(max_length=24, blank=True)),
        ...
        # Adding model 'FlyDR_trn'
        db.create_table('expressions_flydr_trn', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('probe_id', self.gf('django.db.models.fields.CharField')(max_length=23)),
            ('entrez_gene', self.gf('django.db.models.fields.CharField')(max_length=37, blank=True)),
            ('gene_symbol', self.gf('django.db.models.fields.CharField')(max_length=46, blank=True)),
            ('gene_name', self.gf('django.db.models.fields.CharField')(max_length=97, blank=True)),
            ('ensembl_gene', self.gf('django.db.models.fields.CharField')(max_length=11, blank=True)),
            ('exp', self.gf('django.db.models.fields.FloatField')()),
            ('ctr', self.gf('django.db.models.fields.FloatField')()),
            ('fold_change', self.gf('django.db.models.fields.FloatField')()),
            ('entrez_gene_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ...
        db.send_create_signal('expressions', ['FlyDR_trn'])


    def backwards(self, orm):
        
        # Deleting model 'YeastDR'
        db.delete_table('expressions_yeastdr')

        # Deleting model 'WormDR'
        db.delete_table('expressions_wormdr')

        # Deleting model 'FlyDR_trn'
        db.delete_table('expressions_flydr_trn')
