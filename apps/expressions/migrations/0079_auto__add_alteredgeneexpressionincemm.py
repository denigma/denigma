...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AlteredGeneExpressionInCeMM'
        db.create_table('expressions_alteredgeneexpressionincemm', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('fold_change', self.gf('django.db.models.fields.CharField')(max_length=9)),
            ('ensembl', self.gf('django.db.models.fields.CharField')(max_length=9)),
            ('mountain', self.gf('django.db.models.fields.CharField')(max_length=4)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=88)),
            ('regulation', self.gf('django.db.models.fields.CharField')(max_length=4)),
        ))
        db.send_create_signal('expressions', ['AlteredGeneExpressionInCeMM'])


    def backwards(self, orm):
        
        # Deleting model 'AlteredGeneExpressionInCeMM'
        db.delete_table('expressions_alteredgeneexpressionincemm')
