...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Fly_TF_gene.mapping_target'
        db.delete_column('interactions_fly_tf_gene', 'mapping_target')

        # Deleting field 'Fly_TF_gene.mapping_source'
        db.delete_column('interactions_fly_tf_gene', 'mapping_source')

        # Adding field 'Fly_TF_gene.source_mapping'
        db.add_column('interactions_fly_tf_gene', 'source_mapping', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Fly_TF_gene.target_mapping'
        db.add_column('interactions_fly_tf_gene', 'target_mapping', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Fly_TF_gene.mapping_target'
        db.add_column('interactions_fly_tf_gene', 'mapping_target', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Fly_TF_gene.mapping_source'
        db.add_column('interactions_fly_tf_gene', 'mapping_source', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Fly_TF_gene.source_mapping'
        db.delete_column('interactions_fly_tf_gene', 'source_mapping')

        # Deleting field 'Fly_TF_gene.target_mapping'
        db.delete_column('interactions_fly_tf_gene', 'target_mapping')
