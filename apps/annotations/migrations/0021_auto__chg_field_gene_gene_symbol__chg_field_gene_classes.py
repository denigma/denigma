...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Gene.gene_symbol'
        db.alter_column('annotations_gene', 'gene_symbol', self.gf('django.db.models.fields.CharField')(max_length=30))

        # Changing field 'Gene.classes'
        db.alter_column('annotations_gene', 'classes', self.gf('django.db.models.fields.CharField')(max_length=30))


    def backwards(self, orm):
        
        # Changing field 'Gene.gene_symbol'
        db.alter_column('annotations_gene', 'gene_symbol', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Gene.classes'
        db.alter_column('annotations_gene', 'classes', self.gf('django.db.models.fields.CharField')(max_length=20))
