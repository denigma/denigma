...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'gene2ensembl'
        db.create_table('annotations_gene2ensembl', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('taxid', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('entrez_gene_id', self.gf('django.db.models.fields.IntegerField')(db_index=True)),
            ('ensembl_gene_id', self.gf('django.db.models.fields.CharField')(max_length=18, db_index=True)),
            ('rna_nucleotide_accession', self.gf('django.db.models.fields.CharField')(max_length=14)),
            ('ensembl_rna_id', self.gf('django.db.models.fields.CharField')(max_length=18)),
            ('protein_accession', self.gf('django.db.models.fields.CharField')(max_length=14)),
            ('ensembl_protein_id', self.gf('django.db.models.fields.CharField')(max_length=18)),
        ))
        db.send_create_signal('annotations', ['gene2ensembl'])


    def backwards(self, orm):
        
        # Deleting model 'gene2ensembl'
        db.delete_table('annotations_gene2ensembl')
