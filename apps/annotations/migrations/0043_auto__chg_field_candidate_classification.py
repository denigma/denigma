...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Candidate.classification'
        db.alter_column(u'Candidate', 'classification', self.gf('django.db.models.fields.CharField')(max_length=50))


    def backwards(self, orm):
        
        # Changing field 'Candidate.classification'
        db.alter_column(u'Candidate', 'classification', self.gf('django.db.models.fields.CharField')(max_length=30))
