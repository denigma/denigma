...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Ortholog.gene_symbol'
        db.alter_column('annotations_ortholog', 'gene_symbol', self.gf('django.db.models.fields.CharField')(max_length=20))

        # Changing field 'Ortholog.ortholog_symbol'
        db.alter_column('annotations_ortholog', 'ortholog_symbol', self.gf('django.db.models.fields.CharField')(max_length=20))


    def backwards(self, orm):
        
        # Changing field 'Ortholog.gene_symbol'
        db.alter_column('annotations_ortholog', 'gene_symbol', self.gf('django.db.models.fields.IntegerField')())

        # Changing field 'Ortholog.ortholog_symbol'
        db.alter_column('annotations_ortholog', 'ortholog_symbol', self.gf('django.db.models.fields.IntegerField')())
