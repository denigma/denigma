...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Orthologs'
        db.create_table('annotations_orthologs', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ortholog', self.gf('django.db.models.fields.IntegerField')()),
            ('ortholog_symbol', self.gf('django.db.models.fields.IntegerField')()),
            ('orhtolog_taxid', self.gf('django.db.models.fields.IntegerField')()),
            ('gene', self.gf('django.db.models.fields.IntegerField')()),
            ('ortholog_gene_symbol', self.gf('django.db.models.fields.IntegerField')()),
            ('gene_taxid', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal('annotations', ['Orthologs'])


    def backwards(self, orm):
        
        # Deleting model 'Orthologs'
        db.delete_table('annotations_orthologs')
    ...
    models = {
        ...
        'annotations.orthologs': {
            'Meta': {'object_name': 'Orthologs'},
            'gene': ('django.db.models.fields.IntegerField', [], {}),
            'gene_taxid': ('django.db.models.fields.IntegerField', [], {}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'orhtolog_taxid': ('django.db.models.fields.IntegerField', [], {}),
            'ortholog': ('django.db.models.fields.IntegerField', [], {}),
            'ortholog_gene_symbol': ('django.db.models.fields.IntegerField', [], {}),
            'ortholog_symbol': ('django.db.models.fields.IntegerField', [], {})
        },
