...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('southtut_user', 'password')


    def backwards(self, orm):
        
        # Adding field 'User.password'
        db.add_column('southtut_user', 'password', self.gf('django.db.models.fields.CharField')(default='', max_length=60), keep_default=False)
