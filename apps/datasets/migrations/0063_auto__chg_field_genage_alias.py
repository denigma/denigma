...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('datasets_genage', 'alias', self.gf('django.db.models.fields.CharField')(max_length=270))


    def backwards(self, orm):
        
        # Changing field 'GenAge.alias'
        db.alter_column('datasets_genage', 'alias', self.gf('django.db.models.fields.CharField')(max_length=250))
