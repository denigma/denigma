...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('datasets_reference', 'authors', self.gf('django.db.models.fields.TextField')())


    def backwards(self, orm):
        
        # Changing field 'Reference.authors'
        db.alter_column('datasets_reference', 'authors', self.gf('django.db.models.fields.CharField')(max_length=250))
