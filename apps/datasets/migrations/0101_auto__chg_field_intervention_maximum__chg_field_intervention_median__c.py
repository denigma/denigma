...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Intervention.maximum'
        db.alter_column('datasets_intervention', 'maximum', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'Intervention.median'
        db.alter_column('datasets_intervention', 'median', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))

        # Changing field 'Intervention.mean'
        db.alter_column('datasets_intervention', 'mean', self.gf('django.db.models.fields.CharField')(max_length=15, null=True))


    def backwards(self, orm):
        
        # Changing field 'Intervention.maximum'
        db.alter_column('datasets_intervention', 'maximum', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Intervention.median'
        db.alter_column('datasets_intervention', 'median', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))

        # Changing field 'Intervention.mean'
        db.alter_column('datasets_intervention', 'mean', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
    ...
    models = {
        ...
        'datasets.intervention': {
            ...
            'manipulation': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['datasets.Manipulation']", 'symmetrical': 'False', 'blank': 'True'}),
        ...
        'datasets.manipulation': {
            'Meta': {'object_name': 'Manipulation', 'db_table': "u'manipulation'"},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'shortcut': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True', 'blank': 'True'}),
            'type': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'related_name': "'type_of'", 'blank': 'True', 'to': "orm['datasets.Manipulation']"})
        },
