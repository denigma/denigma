...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Reference.journal'
        db.add_column('datasets_reference', 'journal', self.gf('django.db.models.fields.CharField')(default='', max_length=250, blank=True), keep_default=False)

        # Adding field 'Reference.original_publication'
        db.add_column('datasets_reference', 'original_publication', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Reference.journal'
        db.delete_column('datasets_reference', 'journal')

        # Deleting field 'Reference.original_publication'
        db.delete_column('datasets_reference', 'original_publication')
