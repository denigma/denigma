...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Reference.id'
        #db.add_column('datasets_reference', 'id', self.gf('django.db.models.fields.AutoField')(default=None, primary_key=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Reference.id'
        #db.delete_column('datasets_reference', 'id')
