...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GenAge.taxid'
        db.alter_column('datasets_genage', 'taxid', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'GenAge.taxid'
        db.alter_column('datasets_genage', 'taxid', self.gf('django.db.models.fields.IntegerField')(default=None))
