...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GenAge.type'
        db.add_column('datasets_genage', 'type', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'GenAge.type'
        db.delete_column('datasets_genage', 'type')
    ...
    models = {
        ...
        'datasets.genage': {
            ...
            'types': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['datasets.Type']", 'symmetrical': 'False'})
        },
        'datasets.gencc': {
