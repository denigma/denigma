...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('datasets_reference', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pmid', self.gf('django.db.models.fields.IntegerField')(blank=True)),
        ))
        db.send_create_signal('datasets', ['Reference'])
        ...
        # Adding M2M table for field reference on 'Intervention'
        db.create_table('datasets_intervention_reference', (
        ...
        db.create_unique('datasets_intervention_reference', ['intervention_id', 'reference_id'])

        # Adding M2M table for field species on 'Intervention'
        db.create_table('datasets_intervention_species', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('intervention', models.ForeignKey(orm['datasets.intervention'], null=False)),
            ('species', models.ForeignKey(orm['datasets.species'], null=False))
        ))
        db.create_unique('datasets_intervention_species', ['intervention_id', 'species_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field species on 'Intervention'
        db.delete_table('datasets_intervention_species')
    ...
    models = {
        ...
        'datasets.genage': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'intervention': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['datasets.Intervention']", 'symmetrical': 'False'}),
            'mapping': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
