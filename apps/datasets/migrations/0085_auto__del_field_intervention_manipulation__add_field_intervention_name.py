...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Rename field 'Intervention.manipulation'
        db.rename_column('datasets_intervention', 'manipulation',  'name')

        # Adding field 'Intervention.name'
        #db.add_column('datasets_intervention',, self.gf('django.db.models.fields.CharField')(default=None, max_length=250), keep_default=False)


    def backwards(self, orm):
        
        # Rename field 'Intervention.manipulation'
        db.rename_column('datasets_intervention', 'name', 'manipulation')

        # Deleting field 'Intervention.name'
        #db.delete_column('datasets_intervention')
