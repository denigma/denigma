...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GenAge.description'
        db.add_column('datasets_genage', 'description', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GenAge.description'
        db.delete_column('datasets_genage', 'description')
