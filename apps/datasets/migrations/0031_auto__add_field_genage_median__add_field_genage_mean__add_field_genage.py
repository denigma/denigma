...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GenAge.median'
        db.add_column('datasets_genage', 'median', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'GenAge.mean'
        db.add_column('datasets_genage', 'mean', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'GenAge.maximum'
        db.add_column('datasets_genage', 'maximum', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'GenAge.median'
        db.delete_column('datasets_genage', 'median')

        # Deleting field 'GenAge.mean'
        db.delete_column('datasets_genage', 'mean')

        # Deleting field 'GenAge.maximum'
        db.delete_column('datasets_genage', 'maximum')
